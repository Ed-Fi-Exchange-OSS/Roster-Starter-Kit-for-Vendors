...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCredential : IEquatable<EdFiCredential>, IValidatableObject
    {
        ...
        public EdFiCredential(string id = default(string), string credentialIdentifier = default(string), List<EdFiCredentialGradeLevel> gradeLevels = default(List<EdFiCredentialGradeLevel>), string stateOfIssueStateAbbreviationDescriptor = default(string), List<EdFiCredentialAcademicSubject> academicSubjects = default(List<EdFiCredentialAcademicSubject>), string credentialFieldDescriptor = default(string), string credentialTypeDescriptor = default(string), DateTime effectiveDate = default(DateTime), List<EdFiCredentialEndorsement> endorsements = default(List<EdFiCredentialEndorsement>), DateTime expirationDate = default(DateTime), DateTime issuanceDate = default(DateTime), string _namespace = default(string), string teachingCredentialBasisDescriptor = default(string), string teachingCredentialDescriptor = default(string), string etag = default(string), CredentialExtensions ext = default(CredentialExtensions))
        {
            ...
            this.CredentialIdentifier = credentialIdentifier ?? throw new ArgumentNullException("credentialIdentifier is a required property for EdFiCredential and cannot be null");
            // to ensure "gradeLevels" is required (not null)
            this.GradeLevels = gradeLevels ?? throw new ArgumentNullException("gradeLevels is a required property for EdFiCredential and cannot be null");
            // to ensure "stateOfIssueStateAbbreviationDescriptor" is required (not null)
            this.StateOfIssueStateAbbreviationDescriptor = stateOfIssueStateAbbreviationDescriptor ?? throw new ArgumentNullException("stateOfIssueStateAbbreviationDescriptor is a required property for EdFiCredential and cannot be null");
            // to ensure "credentialFieldDescriptor" is required (not null)
            this.CredentialFieldDescriptor = credentialFieldDescriptor ?? throw new ArgumentNullException("credentialFieldDescriptor is a required property for EdFiCredential and cannot be null");
            // to ensure "credentialTypeDescriptor" is required (not null)
            this.CredentialTypeDescriptor = credentialTypeDescriptor ?? throw new ArgumentNullException("credentialTypeDescriptor is a required property for EdFiCredential and cannot be null");
            this.IssuanceDate = issuanceDate;
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiCredential and cannot be null");
            // to ensure "teachingCredentialDescriptor" is required (not null)
            this.TeachingCredentialDescriptor = teachingCredentialDescriptor ?? throw new ArgumentNullException("teachingCredentialDescriptor is a required property for EdFiCredential and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "credentialTypeDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "issuanceDate", IsRequired = true, EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        ...
        [DataMember(Name = "teachingCredentialDescriptor", IsRequired = true, EmitDefaultValue = false)]
