...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAcademicWeek : IEquatable<EdFiAcademicWeek>, IValidatableObject
    {
        ...
        public EdFiAcademicWeek(string id = default(string), string weekIdentifier = default(string), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), int totalInstructionalDays = default(int), string etag = default(string))
        {
            ...
            this.WeekIdentifier = weekIdentifier ?? throw new ArgumentNullException("weekIdentifier is a required property for EdFiAcademicWeek and cannot be null");
            // to ensure "schoolReference" is required (not null)
            this.SchoolReference = schoolReference ?? throw new ArgumentNullException("schoolReference is a required property for EdFiAcademicWeek and cannot be null");
        ...
        [DataMember(Name = "weekIdentifier", IsRequired = true, EmitDefaultValue = false)]
