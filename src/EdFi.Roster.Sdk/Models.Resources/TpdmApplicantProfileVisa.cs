...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileVisa")]
    public partial class TpdmApplicantProfileVisa : IEquatable<TpdmApplicantProfileVisa>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileVisa" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileVisa() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileVisa" /> class.
        /// </summary>
        /// <param name="visaDescriptor">An indicator of a non-US citizen&#39;s Visa type. (required).</param>
        public TpdmApplicantProfileVisa(string visaDescriptor = default(string))
        {
            // to ensure "visaDescriptor" is required (not null)
            this.VisaDescriptor = visaDescriptor ?? throw new ArgumentNullException("visaDescriptor is a required property for TpdmApplicantProfileVisa and cannot be null");
        }
        ...
        [DataMember(Name = "visaDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as TpdmApplicantProfileVisa);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileVisa instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileVisa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileVisa input)
        {
            if (input == null)
                return false;
