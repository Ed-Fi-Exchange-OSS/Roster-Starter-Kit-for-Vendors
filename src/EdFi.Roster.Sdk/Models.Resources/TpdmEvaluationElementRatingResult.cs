...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationElementRatingResult")]
    public partial class TpdmEvaluationElementRatingResult : IEquatable<TpdmEvaluationElementRatingResult>, IValidatableObject
    {
        /// <summary>
        ...
        public TpdmEvaluationElementRatingResult(double rating = default(double), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            ...
            this.RatingResultTitle = ratingResultTitle ?? throw new ArgumentNullException("ratingResultTitle is a required property for TpdmEvaluationElementRatingResult and cannot be null");
            // to ensure "resultDatatypeTypeDescriptor" is required (not null)
            this.ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor ?? throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmEvaluationElementRatingResult and cannot be null");
        }
