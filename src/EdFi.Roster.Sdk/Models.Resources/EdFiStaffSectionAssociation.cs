...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStaffSectionAssociation : IEquatable<EdFiStaffSectionAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStaffSectionAssociation(string id = default(string), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiStaffReference staffReference = default(EdFiStaffReference), DateTime beginDate = default(DateTime), string classroomPositionDescriptor = default(string), DateTime endDate = default(DateTime), bool highlyQualifiedTeacher = default(bool), double percentageContribution = default(double), bool teacherStudentDataLinkExclusion = default(bool), string etag = default(string))
        {
            ...
            this.SectionReference = sectionReference ?? throw new ArgumentNullException("sectionReference is a required property for EdFiStaffSectionAssociation and cannot be null");
            // to ensure "staffReference" is required (not null)
            this.StaffReference = staffReference ?? throw new ArgumentNullException("staffReference is a required property for EdFiStaffSectionAssociation and cannot be null");
            // to ensure "classroomPositionDescriptor" is required (not null)
            this.ClassroomPositionDescriptor = classroomPositionDescriptor ?? throw new ArgumentNullException("classroomPositionDescriptor is a required property for EdFiStaffSectionAssociation and cannot be null");
            this.Id = id;
