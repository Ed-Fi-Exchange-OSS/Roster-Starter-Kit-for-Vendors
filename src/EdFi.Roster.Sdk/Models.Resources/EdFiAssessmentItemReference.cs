...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentItemReference")]
    public partial class EdFiAssessmentItemReference : IEquatable<EdFiAssessmentItemReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAssessmentItemReference(string assessmentIdentifier = default(string), string identificationCode = default(string), string _namespace = default(string), Link link = default(Link))
        {
            ...
            this.AssessmentIdentifier = assessmentIdentifier ?? throw new ArgumentNullException("assessmentIdentifier is a required property for EdFiAssessmentItemReference and cannot be null");
            // to ensure "identificationCode" is required (not null)
            this.IdentificationCode = identificationCode ?? throw new ArgumentNullException("identificationCode is a required property for EdFiAssessmentItemReference and cannot be null");
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentItemReference and cannot be null");
            this.Link = link;
        }
