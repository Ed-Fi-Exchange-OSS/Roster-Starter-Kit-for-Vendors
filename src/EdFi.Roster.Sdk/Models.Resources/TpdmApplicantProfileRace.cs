...
{
    /// <summary>
    /// TpdmApplicantProfileRace
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileRace")]
    public partial class TpdmApplicantProfileRace : IEquatable<TpdmApplicantProfileRace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileRace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileRace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileRace" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            this.RaceDescriptor = raceDescriptor ?? throw new ArgumentNullException("raceDescriptor is a required property for TpdmApplicantProfileRace and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileRace {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileRace);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileRace instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileRace input)
        {
            if (input == null)
                return false;
