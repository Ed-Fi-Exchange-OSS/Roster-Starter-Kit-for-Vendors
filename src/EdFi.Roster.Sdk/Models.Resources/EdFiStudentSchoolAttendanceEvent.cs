...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentSchoolAttendanceEvent : IEquatable<EdFiStudentSchoolAttendanceEvent>, IValidatableObject
    {
        ...
        public EdFiStudentSchoolAttendanceEvent(string id = default(string), string attendanceEventCategoryDescriptor = default(string), DateTime eventDate = default(DateTime), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), EdFiSessionReference sessionReference = default(EdFiSessionReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string arrivalTime = default(string), string attendanceEventReason = default(string), string departureTime = default(string), string educationalEnvironmentDescriptor = default(string), double eventDuration = default(double), int schoolAttendanceDuration = default(int), string etag = default(string))
        {
            ...
            this.AttendanceEventCategoryDescriptor = attendanceEventCategoryDescriptor ?? throw new ArgumentNullException("attendanceEventCategoryDescriptor is a required property for EdFiStudentSchoolAttendanceEvent and cannot be null");
            this.EventDate = eventDate;
            // to ensure "schoolReference" is required (not null)
            this.SchoolReference = schoolReference ?? throw new ArgumentNullException("schoolReference is a required property for EdFiStudentSchoolAttendanceEvent and cannot be null");
            // to ensure "sessionReference" is required (not null)
            this.SessionReference = sessionReference ?? throw new ArgumentNullException("sessionReference is a required property for EdFiStudentSchoolAttendanceEvent and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentSchoolAttendanceEvent and cannot be null");
            this.Id = id;
