...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGradingPeriod : IEquatable<EdFiGradingPeriod>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiGradingPeriod(string id = default(string), string gradingPeriodDescriptor = default(string), int periodSequence = default(int), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), int totalInstructionalDays = default(int), string etag = default(string))
        {
            ...
            this.GradingPeriodDescriptor = gradingPeriodDescriptor ?? throw new ArgumentNullException("gradingPeriodDescriptor is a required property for EdFiGradingPeriod and cannot be null");
            this.PeriodSequence = periodSequence;
            // to ensure "schoolReference" is required (not null)
            this.SchoolReference = schoolReference ?? throw new ArgumentNullException("schoolReference is a required property for EdFiGradingPeriod and cannot be null");
            // to ensure "schoolYearTypeReference" is required (not null)
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiGradingPeriod and cannot be null");
