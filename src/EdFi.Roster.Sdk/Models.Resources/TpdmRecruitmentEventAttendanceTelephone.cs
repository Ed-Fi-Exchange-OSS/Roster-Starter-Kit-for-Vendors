...
{
    /// <summary>
    /// TpdmRecruitmentEventAttendanceTelephone
    /// </summary>
    [DataContract(Name = "tpdm_recruitmentEventAttendanceTelephone")]
    public partial class TpdmRecruitmentEventAttendanceTelephone : IEquatable<TpdmRecruitmentEventAttendanceTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendanceTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmRecruitmentEventAttendanceTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendanceTelephone" /> class.
        /// </summary>
        ...
        public TpdmRecruitmentEventAttendanceTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool doNotPublishIndicator = default(bool), int orderOfPriority = default(int), bool textMessageCapabilityIndicator = default(bool))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for TpdmRecruitmentEventAttendanceTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for TpdmRecruitmentEventAttendanceTelephone and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmRecruitmentEventAttendanceTelephone {\n");
        ...
        {
            return this.Equals(input as TpdmRecruitmentEventAttendanceTelephone);
        }

        /// <summary>
        /// Returns true if TpdmRecruitmentEventAttendanceTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmRecruitmentEventAttendanceTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmRecruitmentEventAttendanceTelephone input)
        {
            if (input == null)
                return false;
