...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse : IEquatable<EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse>, IValidatableObject
    {
        ...
        public EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse(string matrixElement = default(string), int maxNumericResponse = default(int), int minNumericResponse = default(int), bool noResponse = default(bool), int numericResponse = default(int), string textResponse = default(string))
        {
            ...
            this.MatrixElement = matrixElement ?? throw new ArgumentNullException("matrixElement is a required property for EdFiSurveyQuestionResponseSurveyQuestionMatrixElementResponse and cannot be null");
