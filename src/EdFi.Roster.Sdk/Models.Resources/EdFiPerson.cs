...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiPerson : IEquatable<EdFiPerson>, IValidatableObject
    {
        ...
        public EdFiPerson(string id = default(string), string personId = default(string), string sourceSystemDescriptor = default(string), string etag = default(string))
        {
            ...
            this.PersonId = personId ?? throw new ArgumentNullException("personId is a required property for EdFiPerson and cannot be null");
            // to ensure "sourceSystemDescriptor" is required (not null)
            this.SourceSystemDescriptor = sourceSystemDescriptor ?? throw new ArgumentNullException("sourceSystemDescriptor is a required property for EdFiPerson and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
