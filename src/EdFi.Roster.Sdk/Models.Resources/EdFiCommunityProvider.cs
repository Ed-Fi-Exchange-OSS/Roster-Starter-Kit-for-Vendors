...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCommunityProvider : IEquatable<EdFiCommunityProvider>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiCommunityProvider(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), int communityProviderId = default(int), EdFiCommunityOrganizationReference communityOrganizationReference = default(EdFiCommunityOrganizationReference), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), bool licenseExemptIndicator = default(bool), string nameOfInstitution = default(string), string operationalStatusDescriptor = default(string), string providerCategoryDescriptor = default(string), string providerProfitabilityDescriptor = default(string), string providerStatusDescriptor = default(string), bool schoolIndicator = default(bool), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string))
        {
            ...
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for EdFiCommunityProvider and cannot be null");
            this.CommunityProviderId = communityProviderId;
            // to ensure "nameOfInstitution" is required (not null)
            this.NameOfInstitution = nameOfInstitution ?? throw new ArgumentNullException("nameOfInstitution is a required property for EdFiCommunityProvider and cannot be null");
            // to ensure "providerCategoryDescriptor" is required (not null)
            this.ProviderCategoryDescriptor = providerCategoryDescriptor ?? throw new ArgumentNullException("providerCategoryDescriptor is a required property for EdFiCommunityProvider and cannot be null");
            // to ensure "providerStatusDescriptor" is required (not null)
            this.ProviderStatusDescriptor = providerStatusDescriptor ?? throw new ArgumentNullException("providerStatusDescriptor is a required property for EdFiCommunityProvider and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "communityProviderId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "providerCategoryDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "providerStatusDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProviderCategoryDescriptor, length must be less than 306.", new [] { "ProviderCategoryDescriptor" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProviderProfitabilityDescriptor, length must be less than 306.", new [] { "ProviderProfitabilityDescriptor" });
            }

            // ProviderStatusDescriptor (string) maxLength
            if(this.ProviderStatusDescriptor != null && this.ProviderStatusDescriptor.Length > 306)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ProviderStatusDescriptor, length must be less than 306.", new [] { "ProviderStatusDescriptor" });
            }
