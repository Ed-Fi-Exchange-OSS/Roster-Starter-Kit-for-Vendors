...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiStaffReference
    /// </summary>
    [DataContract(Name = "edFi_staffReference")]
    public partial class EdFiStaffReference : IEquatable<EdFiStaffReference>, IValidatableObject
    {
        ...
        public EdFiStaffReference(string staffUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.StaffUniqueId = staffUniqueId ?? throw new ArgumentNullException("staffUniqueId is a required property for EdFiStaffReference and cannot be null");
            this.Link = link;
        }
