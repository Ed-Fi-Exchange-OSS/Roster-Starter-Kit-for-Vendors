...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_graduationPlanRequiredAssessmentScore")]
    public partial class EdFiGraduationPlanRequiredAssessmentScore : IEquatable<EdFiGraduationPlanRequiredAssessmentScore>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGraduationPlanRequiredAssessmentScore" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiGraduationPlanRequiredAssessmentScore() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiGraduationPlanRequiredAssessmentScore" /> class.
        /// </summary>
        ...
        public EdFiGraduationPlanRequiredAssessmentScore(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            this.AssessmentReportingMethodDescriptor = assessmentReportingMethodDescriptor ?? throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiGraduationPlanRequiredAssessmentScore and cannot be null");
        ...
        {
            return this.Equals(input as EdFiGraduationPlanRequiredAssessmentScore);
        }

        /// <summary>
        /// Returns true if EdFiGraduationPlanRequiredAssessmentScore instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiGraduationPlanRequiredAssessmentScore to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiGraduationPlanRequiredAssessmentScore input)
        {
            if (input == null)
                return false;
