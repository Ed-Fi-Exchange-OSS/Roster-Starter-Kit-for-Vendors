...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAssessmentReference : IEquatable<EdFiAssessmentReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAssessmentReference(string assessmentIdentifier = default(string), string _namespace = default(string), Link link = default(Link))
        {
            ...
            this.AssessmentIdentifier = assessmentIdentifier ?? throw new ArgumentNullException("assessmentIdentifier is a required property for EdFiAssessmentReference and cannot be null");
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiAssessmentReference and cannot be null");
            this.Link = link;
        }
