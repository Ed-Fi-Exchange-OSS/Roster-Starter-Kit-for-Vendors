...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class TpdmEvaluationRatingResult : IEquatable<TpdmEvaluationRatingResult>, IValidatableObject
    {
        ...
        public TpdmEvaluationRatingResult(double rating = default(double), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            ...
            this.RatingResultTitle = ratingResultTitle ?? throw new ArgumentNullException("ratingResultTitle is a required property for TpdmEvaluationRatingResult and cannot be null");
            // to ensure "resultDatatypeTypeDescriptor" is required (not null)
            this.ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor ?? throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmEvaluationRatingResult and cannot be null");
        }
