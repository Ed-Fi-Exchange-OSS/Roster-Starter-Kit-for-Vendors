...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_staffSchoolAssociationGradeLevel")]
    public partial class EdFiStaffSchoolAssociationGradeLevel : IEquatable<EdFiStaffSchoolAssociationGradeLevel>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="EdFiStaffSchoolAssociationGradeLevel" /> class.
        /// </summary>
        /// <param name="gradeLevelDescriptor">The grade levels the individual is eligible to teach. (required).</param>
        public EdFiStaffSchoolAssociationGradeLevel(string gradeLevelDescriptor = default(string))
        {
            ...
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiStaffSchoolAssociationGradeLevel and cannot be null");
        }

        /// <summary>
        /// The grade levels the individual is eligible to teach.
        /// </summary>
        /// <value>The grade levels the individual is eligible to teach.</value>
