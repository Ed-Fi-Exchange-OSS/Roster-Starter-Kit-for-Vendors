...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentAcademicSubject")]
    public partial class EdFiAssessmentAcademicSubject : IEquatable<EdFiAssessmentAcademicSubject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentAcademicSubject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentAcademicSubject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentAcademicSubject" /> class.
        /// </summary>
        ...
        public EdFiAssessmentAcademicSubject(string academicSubjectDescriptor = default(string))
        {
            // to ensure "academicSubjectDescriptor" is required (not null)
            this.AcademicSubjectDescriptor = academicSubjectDescriptor ?? throw new ArgumentNullException("academicSubjectDescriptor is a required property for EdFiAssessmentAcademicSubject and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiAssessmentAcademicSubject);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentAcademicSubject instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentAcademicSubject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentAcademicSubject input)
        {
            if (input == null)
                return false;
