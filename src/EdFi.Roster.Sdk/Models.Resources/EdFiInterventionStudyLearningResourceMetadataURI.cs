...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiInterventionStudyLearningResourceMetadataURI : IEquatable<EdFiInterventionStudyLearningResourceMetadataURI>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiInterventionStudyLearningResourceMetadataURI(string learningResourceMetadataURI = default(string))
        {
            // to ensure "learningResourceMetadataURI" is required (not null)
            this.LearningResourceMetadataURI = learningResourceMetadataURI ?? throw new ArgumentNullException("learningResourceMetadataURI is a required property for EdFiInterventionStudyLearningResourceMetadataURI and cannot be null");
        }
        ...
        [DataMember(Name = "learningResourceMetadataURI", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as EdFiInterventionStudyLearningResourceMetadataURI);
        }

        /// <summary>
        /// Returns true if EdFiInterventionStudyLearningResourceMetadataURI instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiInterventionStudyLearningResourceMetadataURI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiInterventionStudyLearningResourceMetadataURI input)
        {
            if (input == null)
                return false;
