...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// TpdmCandidateVisa
    /// </summary>
    [DataContract(Name = "tpdm_candidateVisa")]
    public partial class TpdmCandidateVisa : IEquatable<TpdmCandidateVisa>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateVisa" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateVisa() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateVisa" /> class.
        /// </summary>
        /// <param name="visaDescriptor">An indicator of a non-US citizen&#39;s Visa type. (required).</param>
        public TpdmCandidateVisa(string visaDescriptor = default(string))
        {
            // to ensure "visaDescriptor" is required (not null)
            this.VisaDescriptor = visaDescriptor ?? throw new ArgumentNullException("visaDescriptor is a required property for TpdmCandidateVisa and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCandidateVisa {\n");
        ...
        {
            return this.Equals(input as TpdmCandidateVisa);
        }

        /// <summary>
        /// Returns true if TpdmCandidateVisa instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateVisa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCandidateVisa input)
        {
            if (input == null)
                return false;
