...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStaffDisciplineIncidentAssociation : IEquatable<EdFiStaffDisciplineIncidentAssociation>, IValidatableObject
    {
        ...
        public EdFiStaffDisciplineIncidentAssociation(string id = default(string), List<EdFiStaffDisciplineIncidentAssociationDisciplineIncidentParticipationCode> disciplineIncidentParticipationCodes = default(List<EdFiStaffDisciplineIncidentAssociationDisciplineIncidentParticipationCode>), EdFiDisciplineIncidentReference disciplineIncidentReference = default(EdFiDisciplineIncidentReference), EdFiStaffReference staffReference = default(EdFiStaffReference), string etag = default(string))
        {
            ...
            this.DisciplineIncidentParticipationCodes = disciplineIncidentParticipationCodes ?? throw new ArgumentNullException("disciplineIncidentParticipationCodes is a required property for EdFiStaffDisciplineIncidentAssociation and cannot be null");
            // to ensure "disciplineIncidentReference" is required (not null)
            this.DisciplineIncidentReference = disciplineIncidentReference ?? throw new ArgumentNullException("disciplineIncidentReference is a required property for EdFiStaffDisciplineIncidentAssociation and cannot be null");
            // to ensure "staffReference" is required (not null)
            this.StaffReference = staffReference ?? throw new ArgumentNullException("staffReference is a required property for EdFiStaffDisciplineIncidentAssociation and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
        ...
        [DataMember(Name = "disciplineIncidentParticipationCodes", IsRequired = true, EmitDefaultValue = false)]
