...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentReference : IEquatable<EdFiStudentReference>, IValidatableObject
    {
        ...
        public EdFiStudentReference(string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.StudentUniqueId = studentUniqueId ?? throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentReference and cannot be null");
            this.Link = link;
        }
