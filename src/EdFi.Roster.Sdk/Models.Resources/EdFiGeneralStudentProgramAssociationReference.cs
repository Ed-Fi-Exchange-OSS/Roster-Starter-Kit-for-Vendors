...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGeneralStudentProgramAssociationReference : IEquatable<EdFiGeneralStudentProgramAssociationReference>, IValidatableObject
    {
        ...
        public EdFiGeneralStudentProgramAssociationReference(DateTime beginDate = default(DateTime), int educationOrganizationId = default(int), int programEducationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.ProgramName = programName ?? throw new ArgumentNullException("programName is a required property for EdFiGeneralStudentProgramAssociationReference and cannot be null");
            // to ensure "programTypeDescriptor" is required (not null)
            this.ProgramTypeDescriptor = programTypeDescriptor ?? throw new ArgumentNullException("programTypeDescriptor is a required property for EdFiGeneralStudentProgramAssociationReference and cannot be null");
            // to ensure "studentUniqueId" is required (not null)
            this.StudentUniqueId = studentUniqueId ?? throw new ArgumentNullException("studentUniqueId is a required property for EdFiGeneralStudentProgramAssociationReference and cannot be null");
            this.Link = link;
        }
        ...
        /// </summary>
        /// <value>The identifier assigned to an education organization.</value>
        [DataMember(Name = "programEducationOrganizationId", IsRequired = true, EmitDefaultValue = false)]
