...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationAssociationInternationalAddress")]
    public partial class EdFiStudentEducationOrganizationAssociationInternationalAddress : IEquatable<EdFiStudentEducationOrganizationAssociationInternationalAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationAssociationInternationalAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentEducationOrganizationAssociationInternationalAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationAssociationInternationalAddress" /> class.
        /// </summary>
        ...
        public EdFiStudentEducationOrganizationAssociationInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), string latitude = default(string), string longitude = default(string))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiStudentEducationOrganizationAssociationInternationalAddress and cannot be null");
            // to ensure "countryDescriptor" is required (not null)
            this.CountryDescriptor = countryDescriptor ?? throw new ArgumentNullException("countryDescriptor is a required property for EdFiStudentEducationOrganizationAssociationInternationalAddress and cannot be null");
            // to ensure "addressLine1" is required (not null)
            this.AddressLine1 = addressLine1 ?? throw new ArgumentNullException("addressLine1 is a required property for EdFiStudentEducationOrganizationAssociationInternationalAddress and cannot be null");
        ...
        [DataMember(Name = "countryDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as EdFiStudentEducationOrganizationAssociationInternationalAddress);
        }

        /// <summary>
        /// Returns true if EdFiStudentEducationOrganizationAssociationInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentEducationOrganizationAssociationInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentEducationOrganizationAssociationInternationalAddress input)
        {
            if (input == null)
                return false;
