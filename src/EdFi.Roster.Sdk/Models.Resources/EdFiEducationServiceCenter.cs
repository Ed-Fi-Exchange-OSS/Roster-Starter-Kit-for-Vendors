...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationServiceCenter")]
    public partial class EdFiEducationServiceCenter : IEquatable<EdFiEducationServiceCenter>, IValidatableObject
    {
        ...
        public EdFiEducationServiceCenter(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), int educationServiceCenterId = default(int), EdFiStateEducationAgencyReference stateEducationAgencyReference = default(EdFiStateEducationAgencyReference), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), string nameOfInstitution = default(string), string operationalStatusDescriptor = default(string), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string))
        {
            // to ensure "categories" is required (not null)
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for EdFiEducationServiceCenter and cannot be null");
            this.EducationServiceCenterId = educationServiceCenterId;
            // to ensure "nameOfInstitution" is required (not null)
            this.NameOfInstitution = nameOfInstitution ?? throw new ArgumentNullException("nameOfInstitution is a required property for EdFiEducationServiceCenter and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "educationServiceCenterId", IsRequired = true, EmitDefaultValue = false)]
