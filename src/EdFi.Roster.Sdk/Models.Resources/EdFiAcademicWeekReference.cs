...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAcademicWeekReference : IEquatable<EdFiAcademicWeekReference>, IValidatableObject
    {
        ...
        public EdFiAcademicWeekReference(int schoolId = default(int), string weekIdentifier = default(string), Link link = default(Link))
        {
            ...
            this.WeekIdentifier = weekIdentifier ?? throw new ArgumentNullException("weekIdentifier is a required property for EdFiAcademicWeekReference and cannot be null");
            this.Link = link;
        }
