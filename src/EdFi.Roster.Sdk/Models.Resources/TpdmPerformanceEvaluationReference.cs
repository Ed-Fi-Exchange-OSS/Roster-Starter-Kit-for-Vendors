...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_performanceEvaluationReference")]
    public partial class TpdmPerformanceEvaluationReference : IEquatable<TpdmPerformanceEvaluationReference>, IValidatableObject
    {
        /// <summary>
        ...
        public TpdmPerformanceEvaluationReference(int educationOrganizationId = default(int), string evaluationPeriodDescriptor = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string), Link link = default(Link))
        {
            ...
            this.EvaluationPeriodDescriptor = evaluationPeriodDescriptor ?? throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            // to ensure "performanceEvaluationTitle" is required (not null)
            this.PerformanceEvaluationTitle = performanceEvaluationTitle ?? throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            // to ensure "performanceEvaluationTypeDescriptor" is required (not null)
            this.PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor ?? throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            this.SchoolYear = schoolYear;
            // to ensure "termDescriptor" is required (not null)
            this.TermDescriptor = termDescriptor ?? throw new ArgumentNullException("termDescriptor is a required property for TpdmPerformanceEvaluationReference and cannot be null");
            this.Link = link;
        }
