...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationAssociationElectronicMail")]
    public partial class EdFiStudentEducationOrganizationAssociationElectronicMail : IEquatable<EdFiStudentEducationOrganizationAssociationElectronicMail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationAssociationElectronicMail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentEducationOrganizationAssociationElectronicMail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentEducationOrganizationAssociationElectronicMail" /> class.
        /// </summary>
        ...
        public EdFiStudentEducationOrganizationAssociationElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool doNotPublishIndicator = default(bool), bool primaryEmailAddressIndicator = default(bool))
        {
            // to ensure "electronicMailTypeDescriptor" is required (not null)
            this.ElectronicMailTypeDescriptor = electronicMailTypeDescriptor ?? throw new ArgumentNullException("electronicMailTypeDescriptor is a required property for EdFiStudentEducationOrganizationAssociationElectronicMail and cannot be null");
            // to ensure "electronicMailAddress" is required (not null)
            this.ElectronicMailAddress = electronicMailAddress ?? throw new ArgumentNullException("electronicMailAddress is a required property for EdFiStudentEducationOrganizationAssociationElectronicMail and cannot be null");
        ...
        {
            return this.Equals(input as EdFiStudentEducationOrganizationAssociationElectronicMail);
        }

        /// <summary>
        /// Returns true if EdFiStudentEducationOrganizationAssociationElectronicMail instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentEducationOrganizationAssociationElectronicMail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentEducationOrganizationAssociationElectronicMail input)
        {
            if (input == null)
                return false;
