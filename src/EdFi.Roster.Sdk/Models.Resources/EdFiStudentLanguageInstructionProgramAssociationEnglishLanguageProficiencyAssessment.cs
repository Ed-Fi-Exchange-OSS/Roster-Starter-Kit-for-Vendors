...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment : IEquatable<EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment>, IValidatableObject
    {
        ...
        public EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment(string monitoredDescriptor = default(string), string participationDescriptor = default(string), string proficiencyDescriptor = default(string), string progressDescriptor = default(string), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference))
        {
            ...
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment and cannot be null");
