...
{
    /// <summary>
    /// TpdmCandidateInternationalAddress
    /// </summary>
    [DataContract(Name = "tpdm_candidateInternationalAddress")]
    public partial class TpdmCandidateInternationalAddress : IEquatable<TpdmCandidateInternationalAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateInternationalAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateInternationalAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateInternationalAddress" /> class.
        /// </summary>
        ...
        public TpdmCandidateInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), string latitude = default(string), string longitude = default(string))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for TpdmCandidateInternationalAddress and cannot be null");
            // to ensure "countryDescriptor" is required (not null)
            this.CountryDescriptor = countryDescriptor ?? throw new ArgumentNullException("countryDescriptor is a required property for TpdmCandidateInternationalAddress and cannot be null");
            // to ensure "addressLine1" is required (not null)
            this.AddressLine1 = addressLine1 ?? throw new ArgumentNullException("addressLine1 is a required property for TpdmCandidateInternationalAddress and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCandidateInternationalAddress {\n");
        ...
        {
            return this.Equals(input as TpdmCandidateInternationalAddress);
        }

        /// <summary>
        /// Returns true if TpdmCandidateInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCandidateInternationalAddress input)
        {
            if (input == null)
                return false;
