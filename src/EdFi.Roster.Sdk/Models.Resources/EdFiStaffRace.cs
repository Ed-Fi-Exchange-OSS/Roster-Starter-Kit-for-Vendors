...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStaffRace : IEquatable<EdFiStaffRace>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStaffRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            this.RaceDescriptor = raceDescriptor ?? throw new ArgumentNullException("raceDescriptor is a required property for EdFiStaffRace and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiStaffRace);
        }

        /// <summary>
        /// Returns true if EdFiStaffRace instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffRace input)
        {
            if (input == null)
                return false;
