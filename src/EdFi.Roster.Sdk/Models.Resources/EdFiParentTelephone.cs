...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiParentTelephone : IEquatable<EdFiParentTelephone>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiParentTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool doNotPublishIndicator = default(bool), int orderOfPriority = default(int), bool textMessageCapabilityIndicator = default(bool))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for EdFiParentTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for EdFiParentTelephone and cannot be null");
        ...
        {
            return this.Equals(input as EdFiParentTelephone);
        }

        /// <summary>
        /// Returns true if EdFiParentTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentTelephone input)
        {
            if (input == null)
                return false;
