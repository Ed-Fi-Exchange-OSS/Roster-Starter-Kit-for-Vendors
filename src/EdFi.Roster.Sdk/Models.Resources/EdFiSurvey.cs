...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurvey : IEquatable<EdFiSurvey>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiSurvey(string id = default(string), string _namespace = default(string), string surveyIdentifier = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), EdFiSessionReference sessionReference = default(EdFiSessionReference), int numberAdministered = default(int), string surveyCategoryDescriptor = default(string), string surveyTitle = default(string), string etag = default(string))
        {
            ...
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiSurvey and cannot be null");
            // to ensure "surveyIdentifier" is required (not null)
            this.SurveyIdentifier = surveyIdentifier ?? throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurvey and cannot be null");
            // to ensure "schoolYearTypeReference" is required (not null)
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiSurvey and cannot be null");
            // to ensure "surveyTitle" is required (not null)
            this.SurveyTitle = surveyTitle ?? throw new ArgumentNullException("surveyTitle is a required property for EdFiSurvey and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "surveyTitle", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SurveyCategoryDescriptor, length must be less than 306.", new [] { "SurveyCategoryDescriptor" });
            }

            // SurveyTitle (string) maxLength
            if(this.SurveyTitle != null && this.SurveyTitle.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SurveyTitle, length must be less than 255.", new [] { "SurveyTitle" });
            }
