...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAccountabilityRating : IEquatable<EdFiAccountabilityRating>, IValidatableObject
    {
        ...
        public EdFiAccountabilityRating(string id = default(string), string ratingTitle = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), string rating = default(string), DateTime ratingDate = default(DateTime), string ratingOrganization = default(string), string ratingProgram = default(string), string etag = default(string))
        {
            ...
            this.RatingTitle = ratingTitle ?? throw new ArgumentNullException("ratingTitle is a required property for EdFiAccountabilityRating and cannot be null");
            // to ensure "educationOrganizationReference" is required (not null)
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiAccountabilityRating and cannot be null");
            // to ensure "schoolYearTypeReference" is required (not null)
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiAccountabilityRating and cannot be null");
            // to ensure "rating" is required (not null)
            this.Rating = rating ?? throw new ArgumentNullException("rating is a required property for EdFiAccountabilityRating and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "ratingTitle", IsRequired = true, EmitDefaultValue = false)]
