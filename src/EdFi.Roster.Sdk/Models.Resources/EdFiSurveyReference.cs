...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiSurveyReference
    /// </summary>
    [DataContract(Name = "edFi_surveyReference")]
    public partial class EdFiSurveyReference : IEquatable<EdFiSurveyReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveyReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSurveyReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveyReference" /> class.
        /// </summary>
        ...
        public EdFiSurveyReference(string _namespace = default(string), string surveyIdentifier = default(string), Link link = default(Link))
        {
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiSurveyReference and cannot be null");
            // to ensure "surveyIdentifier" is required (not null)
            this.SurveyIdentifier = surveyIdentifier ?? throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveyReference and cannot be null");
            this.Link = link;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSurveyReference {\n");
        ...
        {
            return this.Equals(input as EdFiSurveyReference);
        }

        /// <summary>
        /// Returns true if EdFiSurveyReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSurveyReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSurveyReference input)
        {
            if (input == null)
                return false;
