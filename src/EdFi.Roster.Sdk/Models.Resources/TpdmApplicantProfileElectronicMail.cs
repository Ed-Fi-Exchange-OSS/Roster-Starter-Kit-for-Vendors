...
{
    /// <summary>
    /// TpdmApplicantProfileElectronicMail
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileElectronicMail")]
    public partial class TpdmApplicantProfileElectronicMail : IEquatable<TpdmApplicantProfileElectronicMail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileElectronicMail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileElectronicMail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileElectronicMail" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool doNotPublishIndicator = default(bool), bool primaryEmailAddressIndicator = default(bool))
        {
            // to ensure "electronicMailTypeDescriptor" is required (not null)
            this.ElectronicMailTypeDescriptor = electronicMailTypeDescriptor ?? throw new ArgumentNullException("electronicMailTypeDescriptor is a required property for TpdmApplicantProfileElectronicMail and cannot be null");
            // to ensure "electronicMailAddress" is required (not null)
            this.ElectronicMailAddress = electronicMailAddress ?? throw new ArgumentNullException("electronicMailAddress is a required property for TpdmApplicantProfileElectronicMail and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileElectronicMail {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileElectronicMail);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileElectronicMail instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileElectronicMail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileElectronicMail input)
        {
            if (input == null)
                return false;
