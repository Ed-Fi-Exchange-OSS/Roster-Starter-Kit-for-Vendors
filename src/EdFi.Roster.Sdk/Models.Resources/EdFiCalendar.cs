...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCalendar : IEquatable<EdFiCalendar>, IValidatableObject
    {
        ...
        public EdFiCalendar(string id = default(string), string calendarCode = default(string), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference), string calendarTypeDescriptor = default(string), List<EdFiCalendarGradeLevel> gradeLevels = default(List<EdFiCalendarGradeLevel>), string etag = default(string))
        {
            // to ensure "calendarCode" is required (not null)
            this.CalendarCode = calendarCode ?? throw new ArgumentNullException("calendarCode is a required property for EdFiCalendar and cannot be null");
            // to ensure "schoolReference" is required (not null)
            this.SchoolReference = schoolReference ?? throw new ArgumentNullException("schoolReference is a required property for EdFiCalendar and cannot be null");
            // to ensure "schoolYearTypeReference" is required (not null)
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiCalendar and cannot be null");
            // to ensure "calendarTypeDescriptor" is required (not null)
            this.CalendarTypeDescriptor = calendarTypeDescriptor ?? throw new ArgumentNullException("calendarTypeDescriptor is a required property for EdFiCalendar and cannot be null");
            this.Id = id;
