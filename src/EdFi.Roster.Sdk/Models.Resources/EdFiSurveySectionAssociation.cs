...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveySectionAssociation : IEquatable<EdFiSurveySectionAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiSurveySectionAssociation(string id = default(string), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiSurveyReference surveyReference = default(EdFiSurveyReference), string etag = default(string))
        {
            ...
            this.SectionReference = sectionReference ?? throw new ArgumentNullException("sectionReference is a required property for EdFiSurveySectionAssociation and cannot be null");
            // to ensure "surveyReference" is required (not null)
            this.SurveyReference = surveyReference ?? throw new ArgumentNullException("surveyReference is a required property for EdFiSurveySectionAssociation and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
