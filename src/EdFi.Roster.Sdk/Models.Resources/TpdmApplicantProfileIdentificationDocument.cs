...
{
    /// <summary>
    /// TpdmApplicantProfileIdentificationDocument
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileIdentificationDocument")]
    public partial class TpdmApplicantProfileIdentificationDocument : IEquatable<TpdmApplicantProfileIdentificationDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime documentExpirationDate = default(DateTime), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            // to ensure "identificationDocumentUseDescriptor" is required (not null)
            this.IdentificationDocumentUseDescriptor = identificationDocumentUseDescriptor ?? throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for TpdmApplicantProfileIdentificationDocument and cannot be null");
            // to ensure "personalInformationVerificationDescriptor" is required (not null)
            this.PersonalInformationVerificationDescriptor = personalInformationVerificationDescriptor ?? throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for TpdmApplicantProfileIdentificationDocument and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileIdentificationDocument {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileIdentificationDocument input)
        {
            if (input == null)
                return false;
