...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGradebookEntryReference : IEquatable<EdFiGradebookEntryReference>, IValidatableObject
    {
        ...
        public EdFiGradebookEntryReference(DateTime dateAssigned = default(DateTime), string gradebookEntryTitle = default(string), string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), Link link = default(Link))
        {
            ...
            this.GradebookEntryTitle = gradebookEntryTitle ?? throw new ArgumentNullException("gradebookEntryTitle is a required property for EdFiGradebookEntryReference and cannot be null");
            // to ensure "localCourseCode" is required (not null)
            this.LocalCourseCode = localCourseCode ?? throw new ArgumentNullException("localCourseCode is a required property for EdFiGradebookEntryReference and cannot be null");
            this.SchoolId = schoolId;
            this.SchoolYear = schoolYear;
            // to ensure "sectionIdentifier" is required (not null)
            this.SectionIdentifier = sectionIdentifier ?? throw new ArgumentNullException("sectionIdentifier is a required property for EdFiGradebookEntryReference and cannot be null");
            // to ensure "sessionName" is required (not null)
            this.SessionName = sessionName ?? throw new ArgumentNullException("sessionName is a required property for EdFiGradebookEntryReference and cannot be null");
            this.Link = link;
        }
        ...
        [DataMember(Name = "dateAssigned", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "gradebookEntryTitle", IsRequired = true, EmitDefaultValue = false)]
