...
{
    /// <summary>
    /// TpdmApplicantProfileGradePointAverage
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileGradePointAverage")]
    public partial class TpdmApplicantProfileGradePointAverage : IEquatable<TpdmApplicantProfileGradePointAverage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileGradePointAverage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileGradePointAverage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileGradePointAverage" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileGradePointAverage(string gradePointAverageTypeDescriptor = default(string), double gradePointAverageValue = default(double), bool isCumulative = default(bool), double maxGradePointAverageValue = default(double))
        {
            // to ensure "gradePointAverageTypeDescriptor" is required (not null)
            this.GradePointAverageTypeDescriptor = gradePointAverageTypeDescriptor ?? throw new ArgumentNullException("gradePointAverageTypeDescriptor is a required property for TpdmApplicantProfileGradePointAverage and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileGradePointAverage {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileGradePointAverage);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileGradePointAverage instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileGradePointAverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileGradePointAverage input)
        {
            if (input == null)
                return false;
