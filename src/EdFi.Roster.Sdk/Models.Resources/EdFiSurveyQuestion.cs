...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveyQuestion : IEquatable<EdFiSurveyQuestion>, IValidatableObject
    {
        ...
        public EdFiSurveyQuestion(string id = default(string), string questionCode = default(string), EdFiSurveyReference surveyReference = default(EdFiSurveyReference), EdFiSurveySectionReference surveySectionReference = default(EdFiSurveySectionReference), List<EdFiSurveyQuestionMatrix> matrices = default(List<EdFiSurveyQuestionMatrix>), string questionFormDescriptor = default(string), string questionText = default(string), List<EdFiSurveyQuestionResponseChoice> responseChoices = default(List<EdFiSurveyQuestionResponseChoice>), string etag = default(string))
        {
            ...
            this.QuestionCode = questionCode ?? throw new ArgumentNullException("questionCode is a required property for EdFiSurveyQuestion and cannot be null");
            // to ensure "surveyReference" is required (not null)
            this.SurveyReference = surveyReference ?? throw new ArgumentNullException("surveyReference is a required property for EdFiSurveyQuestion and cannot be null");
            // to ensure "questionFormDescriptor" is required (not null)
            this.QuestionFormDescriptor = questionFormDescriptor ?? throw new ArgumentNullException("questionFormDescriptor is a required property for EdFiSurveyQuestion and cannot be null");
            // to ensure "questionText" is required (not null)
            this.QuestionText = questionText ?? throw new ArgumentNullException("questionText is a required property for EdFiSurveyQuestion and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "questionFormDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "questionText", IsRequired = true, EmitDefaultValue = false)]
