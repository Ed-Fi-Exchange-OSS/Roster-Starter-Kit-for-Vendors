...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentDisciplineIncidentNonOffenderAssociation : IEquatable<EdFiStudentDisciplineIncidentNonOffenderAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentDisciplineIncidentNonOffenderAssociation(string id = default(string), EdFiDisciplineIncidentReference disciplineIncidentReference = default(EdFiDisciplineIncidentReference), EdFiStudentReference studentReference = default(EdFiStudentReference), List<EdFiStudentDisciplineIncidentNonOffenderAssociationDisciplineIncidentParticipationCode> disciplineIncidentParticipationCodes = default(List<EdFiStudentDisciplineIncidentNonOffenderAssociationDisciplineIncidentParticipationCode>), string etag = default(string))
        {
            ...
            this.DisciplineIncidentReference = disciplineIncidentReference ?? throw new ArgumentNullException("disciplineIncidentReference is a required property for EdFiStudentDisciplineIncidentNonOffenderAssociation and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentDisciplineIncidentNonOffenderAssociation and cannot be null");
            this.Id = id;
