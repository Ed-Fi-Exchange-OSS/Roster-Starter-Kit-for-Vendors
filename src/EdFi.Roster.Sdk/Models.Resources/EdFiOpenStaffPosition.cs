...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiOpenStaffPosition : IEquatable<EdFiOpenStaffPosition>, IValidatableObject
    {
        ...
        public EdFiOpenStaffPosition(string id = default(string), string requisitionNumber = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), List<EdFiOpenStaffPositionAcademicSubject> academicSubjects = default(List<EdFiOpenStaffPositionAcademicSubject>), DateTime datePosted = default(DateTime), DateTime datePostingRemoved = default(DateTime), string employmentStatusDescriptor = default(string), List<EdFiOpenStaffPositionInstructionalGradeLevel> instructionalGradeLevels = default(List<EdFiOpenStaffPositionInstructionalGradeLevel>), string positionTitle = default(string), string postingResultDescriptor = default(string), string programAssignmentDescriptor = default(string), string staffClassificationDescriptor = default(string), string etag = default(string), OpenStaffPositionExtensions ext = default(OpenStaffPositionExtensions))
        {
            // to ensure "requisitionNumber" is required (not null)
            this.RequisitionNumber = requisitionNumber ?? throw new ArgumentNullException("requisitionNumber is a required property for EdFiOpenStaffPosition and cannot be null");
            // to ensure "educationOrganizationReference" is required (not null)
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiOpenStaffPosition and cannot be null");
            this.DatePosted = datePosted;
            // to ensure "employmentStatusDescriptor" is required (not null)
            this.EmploymentStatusDescriptor = employmentStatusDescriptor ?? throw new ArgumentNullException("employmentStatusDescriptor is a required property for EdFiOpenStaffPosition and cannot be null");
            // to ensure "staffClassificationDescriptor" is required (not null)
            this.StaffClassificationDescriptor = staffClassificationDescriptor ?? throw new ArgumentNullException("staffClassificationDescriptor is a required property for EdFiOpenStaffPosition and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "datePosted", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "staffClassificationDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        public OpenStaffPositionExtensions Ext { get; set; }
