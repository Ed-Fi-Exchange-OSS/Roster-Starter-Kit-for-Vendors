...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveyResponse : IEquatable<EdFiSurveyResponse>, IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name = "responseDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        public SurveyResponseExtensions Ext { get; set; }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FullName, length must be less than 80.", new [] { "FullName" });
            }
