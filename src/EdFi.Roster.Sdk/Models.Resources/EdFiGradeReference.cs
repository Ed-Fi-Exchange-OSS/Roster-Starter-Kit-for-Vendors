...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGradeReference : IEquatable<EdFiGradeReference>, IValidatableObject
    {
        ...
        public EdFiGradeReference(DateTime beginDate = default(DateTime), string gradeTypeDescriptor = default(string), string gradingPeriodDescriptor = default(string), int gradingPeriodSchoolYear = default(int), int gradingPeriodSequence = default(int), string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.GradeTypeDescriptor = gradeTypeDescriptor ?? throw new ArgumentNullException("gradeTypeDescriptor is a required property for EdFiGradeReference and cannot be null");
            // to ensure "gradingPeriodDescriptor" is required (not null)
            this.GradingPeriodDescriptor = gradingPeriodDescriptor ?? throw new ArgumentNullException("gradingPeriodDescriptor is a required property for EdFiGradeReference and cannot be null");
            ...
            this.LocalCourseCode = localCourseCode ?? throw new ArgumentNullException("localCourseCode is a required property for EdFiGradeReference and cannot be null");
            this.SchoolId = schoolId;
            this.SchoolYear = schoolYear;
            // to ensure "sectionIdentifier" is required (not null)
            this.SectionIdentifier = sectionIdentifier ?? throw new ArgumentNullException("sectionIdentifier is a required property for EdFiGradeReference and cannot be null");
            // to ensure "sessionName" is required (not null)
            this.SessionName = sessionName ?? throw new ArgumentNullException("sessionName is a required property for EdFiGradeReference and cannot be null");
            // to ensure "studentUniqueId" is required (not null)
            this.StudentUniqueId = studentUniqueId ?? throw new ArgumentNullException("studentUniqueId is a required property for EdFiGradeReference and cannot be null");
            this.Link = link;
        }
        ...
        [DataMember(Name = "gradeTypeDescriptor", IsRequired = true, EmitDefaultValue = false)]
