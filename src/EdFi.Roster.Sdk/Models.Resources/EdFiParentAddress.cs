...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiParentAddress
    /// </summary>
    [DataContract(Name = "edFi_parentAddress")]
    public partial class EdFiParentAddress : IEquatable<EdFiParentAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiParentAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiParentAddress" /> class.
        /// </summary>
        ...
        /// <param name="periods">An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address..</param>
        public EdFiParentAddress(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string localeDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool doNotPublishIndicator = default(bool), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), List<EdFiParentAddressPeriod> periods = default(List<EdFiParentAddressPeriod>))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiParentAddress and cannot be null");
            // to ensure "stateAbbreviationDescriptor" is required (not null)
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor ?? throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for EdFiParentAddress and cannot be null");
            // to ensure "city" is required (not null)
            this.City = city ?? throw new ArgumentNullException("city is a required property for EdFiParentAddress and cannot be null");
            // to ensure "postalCode" is required (not null)
            this.PostalCode = postalCode ?? throw new ArgumentNullException("postalCode is a required property for EdFiParentAddress and cannot be null");
            // to ensure "streetNumberName" is required (not null)
            this.StreetNumberName = streetNumberName ?? throw new ArgumentNullException("streetNumberName is a required property for EdFiParentAddress and cannot be null");
        ...
        /// </summary>
        /// <value>An unordered collection of parentAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.</value>
        [DataMember(Name = "periods", EmitDefaultValue = false)]
        public List<EdFiParentAddressPeriod> Periods { get; set; }
        ...
        {
            return this.Equals(input as EdFiParentAddress);
        }

        /// <summary>
        /// Returns true if EdFiParentAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiParentAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiParentAddress input)
        {
            if (input == null)
                return false;
