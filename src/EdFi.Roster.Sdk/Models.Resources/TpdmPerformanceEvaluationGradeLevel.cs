...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class TpdmPerformanceEvaluationGradeLevel : IEquatable<TpdmPerformanceEvaluationGradeLevel>, IValidatableObject
    {
        ...
        public TpdmPerformanceEvaluationGradeLevel(string gradeLevelDescriptor = default(string))
        {
            ...
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for TpdmPerformanceEvaluationGradeLevel and cannot be null");
        }
