...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_schoolGradeLevel")]
    public partial class EdFiSchoolGradeLevel : IEquatable<EdFiSchoolGradeLevel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolGradeLevel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSchoolGradeLevel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSchoolGradeLevel" /> class.
        /// </summary>
        /// <param name="gradeLevelDescriptor">The grade levels served at the school. (required).</param>
        public EdFiSchoolGradeLevel(string gradeLevelDescriptor = default(string))
        {
            // to ensure "gradeLevelDescriptor" is required (not null)
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiSchoolGradeLevel and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiSchoolGradeLevel);
        }

        /// <summary>
        /// Returns true if EdFiSchoolGradeLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSchoolGradeLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSchoolGradeLevel input)
        {
            if (input == null)
                return false;
