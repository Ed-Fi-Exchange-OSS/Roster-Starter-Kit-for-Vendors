...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCompetencyObjectiveReference : IEquatable<EdFiCompetencyObjectiveReference>, IValidatableObject
    {
        ...
        public EdFiCompetencyObjectiveReference(int educationOrganizationId = default(int), string objective = default(string), string objectiveGradeLevelDescriptor = default(string), Link link = default(Link))
        {
            ...
            this.Objective = objective ?? throw new ArgumentNullException("objective is a required property for EdFiCompetencyObjectiveReference and cannot be null");
            // to ensure "objectiveGradeLevelDescriptor" is required (not null)
            this.ObjectiveGradeLevelDescriptor = objectiveGradeLevelDescriptor ?? throw new ArgumentNullException("objectiveGradeLevelDescriptor is a required property for EdFiCompetencyObjectiveReference and cannot be null");
            this.Link = link;
        }
