...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentDisciplineIncidentBehaviorAssociationReference : IEquatable<EdFiStudentDisciplineIncidentBehaviorAssociationReference>, IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentBehaviorAssociationReference(string behaviorDescriptor = default(string), string incidentIdentifier = default(string), int schoolId = default(int), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.BehaviorDescriptor = behaviorDescriptor ?? throw new ArgumentNullException("behaviorDescriptor is a required property for EdFiStudentDisciplineIncidentBehaviorAssociationReference and cannot be null");
            // to ensure "incidentIdentifier" is required (not null)
            this.IncidentIdentifier = incidentIdentifier ?? throw new ArgumentNullException("incidentIdentifier is a required property for EdFiStudentDisciplineIncidentBehaviorAssociationReference and cannot be null");
            this.SchoolId = schoolId;
            // to ensure "studentUniqueId" is required (not null)
            this.StudentUniqueId = studentUniqueId ?? throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentDisciplineIncidentBehaviorAssociationReference and cannot be null");
            this.Link = link;
        }
