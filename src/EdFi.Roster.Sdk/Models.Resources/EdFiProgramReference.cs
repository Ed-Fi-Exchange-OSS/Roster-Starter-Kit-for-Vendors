...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiProgramReference : IEquatable<EdFiProgramReference>, IValidatableObject
    {
        ...
        public EdFiProgramReference(int educationOrganizationId = default(int), string programName = default(string), string programTypeDescriptor = default(string), Link link = default(Link))
        {
            ...
            this.ProgramName = programName ?? throw new ArgumentNullException("programName is a required property for EdFiProgramReference and cannot be null");
            // to ensure "programTypeDescriptor" is required (not null)
            this.ProgramTypeDescriptor = programTypeDescriptor ?? throw new ArgumentNullException("programTypeDescriptor is a required property for EdFiProgramReference and cannot be null");
            this.Link = link;
        }
