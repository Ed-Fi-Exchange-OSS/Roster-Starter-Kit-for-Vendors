...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_stateEducationAgencyExtension")]
    public partial class TpdmStateEducationAgencyExtension : IEquatable<TpdmStateEducationAgencyExtension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStateEducationAgencyExtension" /> class.
        /// </summary>
        /// <param name="federalLocaleCodeDescriptor">The federal locale code associated with an education organization..</param>
        public TpdmStateEducationAgencyExtension(string federalLocaleCodeDescriptor = default(string))
        {
        ...
        {
            return this.Equals(input as TpdmStateEducationAgencyExtension);
        }

        /// <summary>
        /// Returns true if TpdmStateEducationAgencyExtension instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmStateEducationAgencyExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmStateEducationAgencyExtension input)
        {
            if (input == null)
                return false;
