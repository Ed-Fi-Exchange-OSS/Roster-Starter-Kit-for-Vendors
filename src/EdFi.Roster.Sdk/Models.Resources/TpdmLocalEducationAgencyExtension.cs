...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_localEducationAgencyExtension")]
    public partial class TpdmLocalEducationAgencyExtension : IEquatable<TpdmLocalEducationAgencyExtension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmLocalEducationAgencyExtension" /> class.
        /// </summary>
        /// <param name="federalLocaleCodeDescriptor">The federal locale code associated with an education organization..</param>
        public TpdmLocalEducationAgencyExtension(string federalLocaleCodeDescriptor = default(string))
        {
        ...
        {
            return this.Equals(input as TpdmLocalEducationAgencyExtension);
        }

        /// <summary>
        /// Returns true if TpdmLocalEducationAgencyExtension instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmLocalEducationAgencyExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmLocalEducationAgencyExtension input)
        {
            if (input == null)
                return false;
