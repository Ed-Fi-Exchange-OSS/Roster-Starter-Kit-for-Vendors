...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiLearningObjectiveReference : IEquatable<EdFiLearningObjectiveReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiLearningObjectiveReference(string learningObjectiveId = default(string), string _namespace = default(string), Link link = default(Link))
        {
            ...
            this.LearningObjectiveId = learningObjectiveId ?? throw new ArgumentNullException("learningObjectiveId is a required property for EdFiLearningObjectiveReference and cannot be null");
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiLearningObjectiveReference and cannot be null");
            this.Link = link;
        }
