...
{
    /// <summary>
    /// TpdmRecruitmentEventAttendancePersonalIdentificationDocument
    /// </summary>
    [DataContract(Name = "tpdm_recruitmentEventAttendancePersonalIdentificationDocument")]
    public partial class TpdmRecruitmentEventAttendancePersonalIdentificationDocument : IEquatable<TpdmRecruitmentEventAttendancePersonalIdentificationDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendancePersonalIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmRecruitmentEventAttendancePersonalIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendancePersonalIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmRecruitmentEventAttendancePersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime documentExpirationDate = default(DateTime), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            // to ensure "identificationDocumentUseDescriptor" is required (not null)
            this.IdentificationDocumentUseDescriptor = identificationDocumentUseDescriptor ?? throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for TpdmRecruitmentEventAttendancePersonalIdentificationDocument and cannot be null");
            // to ensure "personalInformationVerificationDescriptor" is required (not null)
            this.PersonalInformationVerificationDescriptor = personalInformationVerificationDescriptor ?? throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for TpdmRecruitmentEventAttendancePersonalIdentificationDocument and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmRecruitmentEventAttendancePersonalIdentificationDocument {\n");
        ...
        {
            return this.Equals(input as TpdmRecruitmentEventAttendancePersonalIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmRecruitmentEventAttendancePersonalIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmRecruitmentEventAttendancePersonalIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmRecruitmentEventAttendancePersonalIdentificationDocument input)
        {
            if (input == null)
                return false;
