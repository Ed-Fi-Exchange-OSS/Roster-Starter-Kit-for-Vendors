...
{
    /// <summary>
    /// TpdmApplicantProfileLanguageUse
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileLanguageUse")]
    public partial class TpdmApplicantProfileLanguageUse : IEquatable<TpdmApplicantProfileLanguageUse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileLanguageUse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileLanguageUse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileLanguageUse" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileLanguageUse(string languageUseDescriptor = default(string))
        {
            // to ensure "languageUseDescriptor" is required (not null)
            this.LanguageUseDescriptor = languageUseDescriptor ?? throw new ArgumentNullException("languageUseDescriptor is a required property for TpdmApplicantProfileLanguageUse and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileLanguageUse {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileLanguageUse);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileLanguageUse instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileLanguageUse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileLanguageUse input)
        {
            if (input == null)
                return false;
