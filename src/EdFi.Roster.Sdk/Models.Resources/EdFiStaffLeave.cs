...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStaffLeave : IEquatable<EdFiStaffLeave>, IValidatableObject
    {
        ...
        public EdFiStaffLeave(string id = default(string), DateTime beginDate = default(DateTime), string staffLeaveEventCategoryDescriptor = default(string), EdFiStaffReference staffReference = default(EdFiStaffReference), DateTime endDate = default(DateTime), string reason = default(string), bool substituteAssigned = default(bool), string etag = default(string))
        {
            ...
            this.StaffLeaveEventCategoryDescriptor = staffLeaveEventCategoryDescriptor ?? throw new ArgumentNullException("staffLeaveEventCategoryDescriptor is a required property for EdFiStaffLeave and cannot be null");
            // to ensure "staffReference" is required (not null)
            this.StaffReference = staffReference ?? throw new ArgumentNullException("staffReference is a required property for EdFiStaffLeave and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "staffLeaveEventCategoryDescriptor", IsRequired = true, EmitDefaultValue = false)]
