...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationObjectiveRatingReference")]
    public partial class TpdmEvaluationObjectiveRatingReference : IEquatable<TpdmEvaluationObjectiveRatingReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationObjectiveRatingReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmEvaluationObjectiveRatingReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmEvaluationObjectiveRatingReference" /> class.
        /// </summary>
        ...
        public TpdmEvaluationObjectiveRatingReference(int educationOrganizationId = default(int), DateTime evaluationDate = default(DateTime), string evaluationObjectiveTitle = default(string), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), string personId = default(string), int schoolYear = default(int), string sourceSystemDescriptor = default(string), string termDescriptor = default(string), Link link = default(Link))
        {
            this.EducationOrganizationId = educationOrganizationId;
            this.EvaluationDate = evaluationDate;
            // to ensure "evaluationObjectiveTitle" is required (not null)
            this.EvaluationObjectiveTitle = evaluationObjectiveTitle ?? throw new ArgumentNullException("evaluationObjectiveTitle is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            // to ensure "evaluationPeriodDescriptor" is required (not null)
            this.EvaluationPeriodDescriptor = evaluationPeriodDescriptor ?? throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            // to ensure "evaluationTitle" is required (not null)
            this.EvaluationTitle = evaluationTitle ?? throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            // to ensure "performanceEvaluationTitle" is required (not null)
            this.PerformanceEvaluationTitle = performanceEvaluationTitle ?? throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            // to ensure "performanceEvaluationTypeDescriptor" is required (not null)
            this.PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor ?? throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            // to ensure "personId" is required (not null)
            this.PersonId = personId ?? throw new ArgumentNullException("personId is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            this.SchoolYear = schoolYear;
            // to ensure "sourceSystemDescriptor" is required (not null)
            this.SourceSystemDescriptor = sourceSystemDescriptor ?? throw new ArgumentNullException("sourceSystemDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            // to ensure "termDescriptor" is required (not null)
            this.TermDescriptor = termDescriptor ?? throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationObjectiveRatingReference and cannot be null");
            this.Link = link;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmEvaluationObjectiveRatingReference {\n");
        ...
        {
            return this.Equals(input as TpdmEvaluationObjectiveRatingReference);
        }

        /// <summary>
        /// Returns true if TpdmEvaluationObjectiveRatingReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmEvaluationObjectiveRatingReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmEvaluationObjectiveRatingReference input)
        {
            if (input == null)
                return false;
