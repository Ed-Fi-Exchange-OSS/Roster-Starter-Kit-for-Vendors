...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentCompetencyObjective : IEquatable<EdFiStudentCompetencyObjective>, IValidatableObject
    {
        ...
        public EdFiStudentCompetencyObjective(string id = default(string), EdFiGradingPeriodReference gradingPeriodReference = default(EdFiGradingPeriodReference), EdFiCompetencyObjectiveReference objectiveCompetencyObjectiveReference = default(EdFiCompetencyObjectiveReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string competencyLevelDescriptor = default(string), string diagnosticStatement = default(string), List<EdFiStudentCompetencyObjectiveGeneralStudentProgramAssociation> generalStudentProgramAssociations = default(List<EdFiStudentCompetencyObjectiveGeneralStudentProgramAssociation>), List<EdFiStudentCompetencyObjectiveStudentSectionAssociation> studentSectionAssociations = default(List<EdFiStudentCompetencyObjectiveStudentSectionAssociation>), string etag = default(string))
        {
            ...
            this.GradingPeriodReference = gradingPeriodReference ?? throw new ArgumentNullException("gradingPeriodReference is a required property for EdFiStudentCompetencyObjective and cannot be null");
            // to ensure "objectiveCompetencyObjectiveReference" is required (not null)
            this.ObjectiveCompetencyObjectiveReference = objectiveCompetencyObjectiveReference ?? throw new ArgumentNullException("objectiveCompetencyObjectiveReference is a required property for EdFiStudentCompetencyObjective and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentCompetencyObjective and cannot be null");
            // to ensure "competencyLevelDescriptor" is required (not null)
            this.CompetencyLevelDescriptor = competencyLevelDescriptor ?? throw new ArgumentNullException("competencyLevelDescriptor is a required property for EdFiStudentCompetencyObjective and cannot be null");
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "objectiveCompetencyObjectiveReference", IsRequired = true, EmitDefaultValue = false)]
