...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_staffEducationOrganizationContactAssociationTelephone")]
    public partial class EdFiStaffEducationOrganizationContactAssociationTelephone : IEquatable<EdFiStaffEducationOrganizationContactAssociationTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffEducationOrganizationContactAssociationTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStaffEducationOrganizationContactAssociationTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffEducationOrganizationContactAssociationTelephone" /> class.
        /// </summary>
        ...
        public EdFiStaffEducationOrganizationContactAssociationTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool doNotPublishIndicator = default(bool), int orderOfPriority = default(int), bool textMessageCapabilityIndicator = default(bool))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for EdFiStaffEducationOrganizationContactAssociationTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for EdFiStaffEducationOrganizationContactAssociationTelephone and cannot be null");
        ...
        {
            return this.Equals(input as EdFiStaffEducationOrganizationContactAssociationTelephone);
        }

        /// <summary>
        /// Returns true if EdFiStaffEducationOrganizationContactAssociationTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffEducationOrganizationContactAssociationTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffEducationOrganizationContactAssociationTelephone input)
        {
            if (input == null)
                return false;
