...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentCompetencyObjectiveReference : IEquatable<EdFiStudentCompetencyObjectiveReference>, IValidatableObject
    {
        ...
        public EdFiStudentCompetencyObjectiveReference(string gradingPeriodDescriptor = default(string), int gradingPeriodSchoolId = default(int), int gradingPeriodSchoolYear = default(int), int gradingPeriodSequence = default(int), string objective = default(string), int objectiveEducationOrganizationId = default(int), string objectiveGradeLevelDescriptor = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.GradingPeriodDescriptor = gradingPeriodDescriptor ?? throw new ArgumentNullException("gradingPeriodDescriptor is a required property for EdFiStudentCompetencyObjectiveReference and cannot be null");
            ...
            this.Objective = objective ?? throw new ArgumentNullException("objective is a required property for EdFiStudentCompetencyObjectiveReference and cannot be null");
            ...
            this.ObjectiveGradeLevelDescriptor = objectiveGradeLevelDescriptor ?? throw new ArgumentNullException("objectiveGradeLevelDescriptor is a required property for EdFiStudentCompetencyObjectiveReference and cannot be null");
            // to ensure "studentUniqueId" is required (not null)
            this.StudentUniqueId = studentUniqueId ?? throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentCompetencyObjectiveReference and cannot be null");
            this.Link = link;
        }
        ...
        [DataMember(Name = "objectiveEducationOrganizationId", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "objectiveGradeLevelDescriptor", IsRequired = true, EmitDefaultValue = false)]
