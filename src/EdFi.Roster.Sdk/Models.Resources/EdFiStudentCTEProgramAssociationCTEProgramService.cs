...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentCTEProgramAssociationCTEProgramService : IEquatable<EdFiStudentCTEProgramAssociationCTEProgramService>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentCTEProgramAssociationCTEProgramService(string cteProgramServiceDescriptor = default(string), string cipCode = default(string), bool primaryIndicator = default(bool), DateTime serviceBeginDate = default(DateTime), DateTime serviceEndDate = default(DateTime))
        {
            ...
            this.CteProgramServiceDescriptor = cteProgramServiceDescriptor ?? throw new ArgumentNullException("cteProgramServiceDescriptor is a required property for EdFiStudentCTEProgramAssociationCTEProgramService and cannot be null");
        ...
        [DataMember(Name = "cteProgramServiceDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CteProgramServiceDescriptor, length must be less than 306.", new [] { "CteProgramServiceDescriptor" });
            }
