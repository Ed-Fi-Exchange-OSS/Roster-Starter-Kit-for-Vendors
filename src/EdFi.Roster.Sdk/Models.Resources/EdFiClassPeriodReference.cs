...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_classPeriodReference")]
    public partial class EdFiClassPeriodReference : IEquatable<EdFiClassPeriodReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiClassPeriodReference(string classPeriodName = default(string), int schoolId = default(int), Link link = default(Link))
        {
            ...
            this.ClassPeriodName = classPeriodName ?? throw new ArgumentNullException("classPeriodName is a required property for EdFiClassPeriodReference and cannot be null");
