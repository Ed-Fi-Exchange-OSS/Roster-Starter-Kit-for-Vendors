...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiCohortProgram
    /// </summary>
    [DataContract(Name = "edFi_cohortProgram")]
    public partial class EdFiCohortProgram : IEquatable<EdFiCohortProgram>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortProgram" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCohortProgram() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCohortProgram" /> class.
        /// </summary>
        ...
        public EdFiCohortProgram(EdFiProgramReference programReference = default(EdFiProgramReference))
        {
            ...
            this.ProgramReference = programReference ?? throw new ArgumentNullException("programReference is a required property for EdFiCohortProgram and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiCohortProgram);
        }

        /// <summary>
        /// Returns true if EdFiCohortProgram instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCohortProgram to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCohortProgram input)
        {
            if (input == null)
                return false;
