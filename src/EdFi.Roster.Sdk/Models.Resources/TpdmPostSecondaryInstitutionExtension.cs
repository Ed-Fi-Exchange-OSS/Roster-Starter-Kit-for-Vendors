...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_postSecondaryInstitutionExtension")]
    public partial class TpdmPostSecondaryInstitutionExtension : IEquatable<TpdmPostSecondaryInstitutionExtension>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmPostSecondaryInstitutionExtension" /> class.
        /// </summary>
        /// <param name="federalLocaleCodeDescriptor">The federal locale code associated with an education organization..</param>
        public TpdmPostSecondaryInstitutionExtension(string federalLocaleCodeDescriptor = default(string))
        {
        ...
        {
            return this.Equals(input as TpdmPostSecondaryInstitutionExtension);
        }

        /// <summary>
        /// Returns true if TpdmPostSecondaryInstitutionExtension instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmPostSecondaryInstitutionExtension to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmPostSecondaryInstitutionExtension input)
        {
            if (input == null)
                return false;
