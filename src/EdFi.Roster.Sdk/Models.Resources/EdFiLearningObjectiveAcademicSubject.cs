...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_learningObjectiveAcademicSubject")]
    public partial class EdFiLearningObjectiveAcademicSubject : IEquatable<EdFiLearningObjectiveAcademicSubject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningObjectiveAcademicSubject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLearningObjectiveAcademicSubject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningObjectiveAcademicSubject" /> class.
        /// </summary>
        ...
        public EdFiLearningObjectiveAcademicSubject(string academicSubjectDescriptor = default(string))
        {
            // to ensure "academicSubjectDescriptor" is required (not null)
            this.AcademicSubjectDescriptor = academicSubjectDescriptor ?? throw new ArgumentNullException("academicSubjectDescriptor is a required property for EdFiLearningObjectiveAcademicSubject and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiLearningObjectiveAcademicSubject);
        }

        /// <summary>
        /// Returns true if EdFiLearningObjectiveAcademicSubject instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLearningObjectiveAcademicSubject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLearningObjectiveAcademicSubject input)
        {
            if (input == null)
                return false;
