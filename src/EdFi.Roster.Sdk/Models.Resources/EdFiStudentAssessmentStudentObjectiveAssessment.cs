...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentAssessmentStudentObjectiveAssessment : IEquatable<EdFiStudentAssessmentStudentObjectiveAssessment>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessment(EdFiObjectiveAssessmentReference objectiveAssessmentReference = default(EdFiObjectiveAssessmentReference), List<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel> performanceLevels = default(List<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel>), List<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult> scoreResults = default(List<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult>))
        {
            ...
            this.ObjectiveAssessmentReference = objectiveAssessmentReference ?? throw new ArgumentNullException("objectiveAssessmentReference is a required property for EdFiStudentAssessmentStudentObjectiveAssessment and cannot be null");
            // to ensure "scoreResults" is required (not null)
            this.ScoreResults = scoreResults ?? throw new ArgumentNullException("scoreResults is a required property for EdFiStudentAssessmentStudentObjectiveAssessment and cannot be null");
        ...
        [DataMember(Name = "scoreResults", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentStudentObjectiveAssessment);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentStudentObjectiveAssessment instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentStudentObjectiveAssessment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentStudentObjectiveAssessment input)
        {
            if (input == null)
                return false;
