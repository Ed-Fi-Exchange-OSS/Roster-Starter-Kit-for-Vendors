...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseOfferingReference")]
    public partial class EdFiCourseOfferingReference : IEquatable<EdFiCourseOfferingReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiCourseOfferingReference(string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sessionName = default(string), Link link = default(Link))
        {
            ...
            this.LocalCourseCode = localCourseCode ?? throw new ArgumentNullException("localCourseCode is a required property for EdFiCourseOfferingReference and cannot be null");
            this.SchoolId = schoolId;
            this.SchoolYear = schoolYear;
            // to ensure "sessionName" is required (not null)
            this.SessionName = sessionName ?? throw new ArgumentNullException("sessionName is a required property for EdFiCourseOfferingReference and cannot be null");
            this.Link = link;
        }
