...
{
    /// <summary>
    /// TpdmApplicantProfileInternationalAddress
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileInternationalAddress")]
    public partial class TpdmApplicantProfileInternationalAddress : IEquatable<TpdmApplicantProfileInternationalAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileInternationalAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileInternationalAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileInternationalAddress" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), string latitude = default(string), string longitude = default(string))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for TpdmApplicantProfileInternationalAddress and cannot be null");
            // to ensure "countryDescriptor" is required (not null)
            this.CountryDescriptor = countryDescriptor ?? throw new ArgumentNullException("countryDescriptor is a required property for TpdmApplicantProfileInternationalAddress and cannot be null");
            // to ensure "addressLine1" is required (not null)
            this.AddressLine1 = addressLine1 ?? throw new ArgumentNullException("addressLine1 is a required property for TpdmApplicantProfileInternationalAddress and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileInternationalAddress {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileInternationalAddress);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileInternationalAddress input)
        {
            if (input == null)
                return false;
