...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentGradebookEntry : IEquatable<EdFiStudentGradebookEntry>, IValidatableObject
    {
        ...
        public EdFiStudentGradebookEntry(string id = default(string), EdFiGradebookEntryReference gradebookEntryReference = default(EdFiGradebookEntryReference), EdFiStudentSectionAssociationReference studentSectionAssociationReference = default(EdFiStudentSectionAssociationReference), string competencyLevelDescriptor = default(string), DateTime dateFulfilled = default(DateTime), string diagnosticStatement = default(string), string letterGradeEarned = default(string), double numericGradeEarned = default(double), string etag = default(string), StudentGradebookEntryExtensions ext = default(StudentGradebookEntryExtensions))
        {
            // to ensure "gradebookEntryReference" is required (not null)
            this.GradebookEntryReference = gradebookEntryReference ?? throw new ArgumentNullException("gradebookEntryReference is a required property for EdFiStudentGradebookEntry and cannot be null");
            // to ensure "studentSectionAssociationReference" is required (not null)
            this.StudentSectionAssociationReference = studentSectionAssociationReference ?? throw new ArgumentNullException("studentSectionAssociationReference is a required property for EdFiStudentGradebookEntry and cannot be null");
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "gradebookEntryReference", IsRequired = true, EmitDefaultValue = false)]
        ...
        public StudentGradebookEntryExtensions Ext { get; set; }
