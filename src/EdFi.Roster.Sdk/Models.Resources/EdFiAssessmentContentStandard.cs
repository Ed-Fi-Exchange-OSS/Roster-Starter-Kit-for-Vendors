...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAssessmentContentStandard : IEquatable<EdFiAssessmentContentStandard>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EdFiAssessmentContentStandard);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentContentStandard instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentContentStandard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentContentStandard input)
        {
            if (input == null)
                return false;
