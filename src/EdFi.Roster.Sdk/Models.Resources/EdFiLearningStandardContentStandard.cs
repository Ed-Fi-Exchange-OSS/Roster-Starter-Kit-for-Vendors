...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiLearningStandardContentStandard : IEquatable<EdFiLearningStandardContentStandard>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiLearningStandardContentStandard(string publicationStatusDescriptor = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), DateTime publicationDate = default(DateTime), int publicationYear = default(int), string title = default(string), string uri = default(string), string version = default(string), EdFiEducationOrganizationReference mandatingEducationOrganizationReference = default(EdFiEducationOrganizationReference), List<EdFiLearningStandardContentStandardAuthor> authors = default(List<EdFiLearningStandardContentStandardAuthor>))
        {
            ...
            this.Title = title ?? throw new ArgumentNullException("title is a required property for EdFiLearningStandardContentStandard and cannot be null");
        ...
        {
            return this.Equals(input as EdFiLearningStandardContentStandard);
        }

        /// <summary>
        /// Returns true if EdFiLearningStandardContentStandard instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLearningStandardContentStandard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLearningStandardContentStandard input)
        {
            if (input == null)
                return false;
