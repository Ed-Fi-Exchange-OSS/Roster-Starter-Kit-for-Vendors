...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveySectionResponse : IEquatable<EdFiSurveySectionResponse>, IValidatableObject
    {
        ...
        public EdFiSurveySectionResponse(string id = default(string), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), EdFiSurveySectionReference surveySectionReference = default(EdFiSurveySectionReference), double sectionRating = default(double), string etag = default(string))
        {
            ...
            this.SurveyResponseReference = surveyResponseReference ?? throw new ArgumentNullException("surveyResponseReference is a required property for EdFiSurveySectionResponse and cannot be null");
            // to ensure "surveySectionReference" is required (not null)
            this.SurveySectionReference = surveySectionReference ?? throw new ArgumentNullException("surveySectionReference is a required property for EdFiSurveySectionResponse and cannot be null");
            this.Id = id;
