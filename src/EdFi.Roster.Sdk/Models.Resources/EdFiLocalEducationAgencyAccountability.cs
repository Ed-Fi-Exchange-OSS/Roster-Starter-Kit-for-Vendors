...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiLocalEducationAgencyAccountability : IEquatable<EdFiLocalEducationAgencyAccountability>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiLocalEducationAgencyAccountability(string gunFreeSchoolsActReportingStatusDescriptor = default(string), string schoolChoiceImplementStatusDescriptor = default(string), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference))
        {
            ...
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiLocalEducationAgencyAccountability and cannot be null");
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GunFreeSchoolsActReportingStatusDescriptor, length must be less than 306.", new [] { "GunFreeSchoolsActReportingStatusDescriptor" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SchoolChoiceImplementStatusDescriptor, length must be less than 306.", new [] { "SchoolChoiceImplementStatusDescriptor" });
            }
