...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiLearningStandardIdentificationCode : IEquatable<EdFiLearningStandardIdentificationCode>, IValidatableObject
    {
        ...
        public EdFiLearningStandardIdentificationCode(string contentStandardName = default(string), string identificationCode = default(string))
        {
            ...
            this.ContentStandardName = contentStandardName ?? throw new ArgumentNullException("contentStandardName is a required property for EdFiLearningStandardIdentificationCode and cannot be null");
            // to ensure "identificationCode" is required (not null)
            this.IdentificationCode = identificationCode ?? throw new ArgumentNullException("identificationCode is a required property for EdFiLearningStandardIdentificationCode and cannot be null");
        }
        ...
        [DataMember(Name = "contentStandardName", IsRequired = true, EmitDefaultValue = false)]
