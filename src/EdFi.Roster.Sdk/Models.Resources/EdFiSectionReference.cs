...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSectionReference : IEquatable<EdFiSectionReference>, IValidatableObject
    {
        ...
        public EdFiSectionReference(string localCourseCode = default(string), int schoolId = default(int), int schoolYear = default(int), string sectionIdentifier = default(string), string sessionName = default(string), Link link = default(Link))
        {
            ...
            this.LocalCourseCode = localCourseCode ?? throw new ArgumentNullException("localCourseCode is a required property for EdFiSectionReference and cannot be null");
            this.SchoolId = schoolId;
            this.SchoolYear = schoolYear;
            // to ensure "sectionIdentifier" is required (not null)
            this.SectionIdentifier = sectionIdentifier ?? throw new ArgumentNullException("sectionIdentifier is a required property for EdFiSectionReference and cannot be null");
            // to ensure "sessionName" is required (not null)
            this.SessionName = sessionName ?? throw new ArgumentNullException("sessionName is a required property for EdFiSectionReference and cannot be null");
            this.Link = link;
        }
