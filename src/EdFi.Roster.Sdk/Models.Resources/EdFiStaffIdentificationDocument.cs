...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStaffIdentificationDocument : IEquatable<EdFiStaffIdentificationDocument>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStaffIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime documentExpirationDate = default(DateTime), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            ...
            this.IdentificationDocumentUseDescriptor = identificationDocumentUseDescriptor ?? throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for EdFiStaffIdentificationDocument and cannot be null");
            // to ensure "personalInformationVerificationDescriptor" is required (not null)
            this.PersonalInformationVerificationDescriptor = personalInformationVerificationDescriptor ?? throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for EdFiStaffIdentificationDocument and cannot be null");
        ...
        {
            return this.Equals(input as EdFiStaffIdentificationDocument);
        }

        /// <summary>
        /// Returns true if EdFiStaffIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffIdentificationDocument input)
        {
            if (input == null)
                return false;
