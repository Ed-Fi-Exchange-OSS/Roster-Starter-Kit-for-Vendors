...
{
    /// <summary>
    /// TpdmCandidateIdentificationDocument
    /// </summary>
    [DataContract(Name = "tpdm_candidateIdentificationDocument")]
    public partial class TpdmCandidateIdentificationDocument : IEquatable<TpdmCandidateIdentificationDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmCandidateIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime documentExpirationDate = default(DateTime), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            // to ensure "identificationDocumentUseDescriptor" is required (not null)
            this.IdentificationDocumentUseDescriptor = identificationDocumentUseDescriptor ?? throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for TpdmCandidateIdentificationDocument and cannot be null");
            // to ensure "personalInformationVerificationDescriptor" is required (not null)
            this.PersonalInformationVerificationDescriptor = personalInformationVerificationDescriptor ?? throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for TpdmCandidateIdentificationDocument and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmCandidateIdentificationDocument {\n");
        ...
        {
            return this.Equals(input as TpdmCandidateIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmCandidateIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCandidateIdentificationDocument input)
        {
            if (input == null)
                return false;
