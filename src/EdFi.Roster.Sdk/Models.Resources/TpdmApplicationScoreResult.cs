...
{
    /// <summary>
    /// TpdmApplicationScoreResult
    /// </summary>
    [DataContract(Name = "tpdm_applicationScoreResult")]
    public partial class TpdmApplicationScoreResult : IEquatable<TpdmApplicationScoreResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationScoreResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicationScoreResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicationScoreResult" /> class.
        /// </summary>
        ...
        public TpdmApplicationScoreResult(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string result = default(string))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            this.AssessmentReportingMethodDescriptor = assessmentReportingMethodDescriptor ?? throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for TpdmApplicationScoreResult and cannot be null");
            // to ensure "resultDatatypeTypeDescriptor" is required (not null)
            this.ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor ?? throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmApplicationScoreResult and cannot be null");
            // to ensure "result" is required (not null)
            this.Result = result ?? throw new ArgumentNullException("result is a required property for TpdmApplicationScoreResult and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicationScoreResult {\n");
        ...
        {
            return this.Equals(input as TpdmApplicationScoreResult);
        }

        /// <summary>
        /// Returns true if TpdmApplicationScoreResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicationScoreResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicationScoreResult input)
        {
            if (input == null)
                return false;
