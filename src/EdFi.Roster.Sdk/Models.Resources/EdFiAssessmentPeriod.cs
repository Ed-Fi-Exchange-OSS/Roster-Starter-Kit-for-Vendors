...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAssessmentPeriod : IEquatable<EdFiAssessmentPeriod>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAssessmentPeriod(string assessmentPeriodDescriptor = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime))
        {
            ...
            this.AssessmentPeriodDescriptor = assessmentPeriodDescriptor ?? throw new ArgumentNullException("assessmentPeriodDescriptor is a required property for EdFiAssessmentPeriod and cannot be null");
