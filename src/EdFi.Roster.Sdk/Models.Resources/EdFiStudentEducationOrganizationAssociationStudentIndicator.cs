...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationStudentIndicator : IEquatable<EdFiStudentEducationOrganizationAssociationStudentIndicator>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationAssociationStudentIndicator(string indicatorName = default(string), string designatedBy = default(string), string indicator = default(string), string indicatorGroup = default(string), List<EdFiStudentEducationOrganizationAssociationStudentIndicatorPeriod> periods = default(List<EdFiStudentEducationOrganizationAssociationStudentIndicatorPeriod>))
        {
            ...
            this.IndicatorName = indicatorName ?? throw new ArgumentNullException("indicatorName is a required property for EdFiStudentEducationOrganizationAssociationStudentIndicator and cannot be null");
            // to ensure "indicator" is required (not null)
            this.Indicator = indicator ?? throw new ArgumentNullException("indicator is a required property for EdFiStudentEducationOrganizationAssociationStudentIndicator and cannot be null");
