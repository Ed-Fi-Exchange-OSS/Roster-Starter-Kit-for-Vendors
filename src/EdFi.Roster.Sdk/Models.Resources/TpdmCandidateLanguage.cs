...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class TpdmCandidateLanguage : IEquatable<TpdmCandidateLanguage>, IValidatableObject
    {
        ...
        public TpdmCandidateLanguage(string languageDescriptor = default(string), List<TpdmCandidateLanguageUse> uses = default(List<TpdmCandidateLanguageUse>))
        {
            ...
            this.LanguageDescriptor = languageDescriptor ?? throw new ArgumentNullException("languageDescriptor is a required property for TpdmCandidateLanguage and cannot be null");
            this.Uses = uses;
        }
