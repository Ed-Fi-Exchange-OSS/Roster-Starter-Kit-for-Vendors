...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentProgramAssociation")]
    public partial class EdFiStudentProgramAssociation : IEquatable<EdFiStudentProgramAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentProgramAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentProgramAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentProgramAssociation" /> class.
        /// </summary>
        ...
        public EdFiStudentProgramAssociation(string id = default(string), DateTime beginDate = default(DateTime), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime endDate = default(DateTime), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool servedOutsideOfRegularSession = default(bool), List<EdFiStudentProgramAssociationService> services = default(List<EdFiStudentProgramAssociationService>), string etag = default(string))
        {
            ...
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiStudentProgramAssociation and cannot be null");
            // to ensure "programReference" is required (not null)
            this.ProgramReference = programReference ?? throw new ArgumentNullException("programReference is a required property for EdFiStudentProgramAssociation and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentProgramAssociation and cannot be null");
            this.Id = id;
        ...
        public List<EdFiStudentProgramAssociationService> Services { get; set; }
        ...
        {
            return this.Equals(input as EdFiStudentProgramAssociation);
        }

        /// <summary>
        /// Returns true if EdFiStudentProgramAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentProgramAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentProgramAssociation input)
        {
            if (input == null)
                return false;
