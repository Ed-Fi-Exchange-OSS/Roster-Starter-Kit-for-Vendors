...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAccountCode : IEquatable<EdFiAccountCode>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAccountCode(string id = default(string), string accountClassificationDescriptor = default(string), string accountCodeNumber = default(string), int fiscalYear = default(int), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), string accountCodeDescription = default(string), string etag = default(string))
        {
            ...
            this.AccountClassificationDescriptor = accountClassificationDescriptor ?? throw new ArgumentNullException("accountClassificationDescriptor is a required property for EdFiAccountCode and cannot be null");
            // to ensure "accountCodeNumber" is required (not null)
            this.AccountCodeNumber = accountCodeNumber ?? throw new ArgumentNullException("accountCodeNumber is a required property for EdFiAccountCode and cannot be null");
            this.FiscalYear = fiscalYear;
            // to ensure "educationOrganizationReference" is required (not null)
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiAccountCode and cannot be null");
            this.Id = id;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountCodeDescription, length must be less than 1024.", new [] { "AccountCodeDescription" });
            }
