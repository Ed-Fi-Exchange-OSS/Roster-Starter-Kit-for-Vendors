...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiParentOtherName
    /// </summary>
    [DataContract(Name = "edFi_parentOtherName")]
    public partial class EdFiParentOtherName : IEquatable<EdFiParentOtherName>, IValidatableObject
    {
        ...
        public EdFiParentOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            ...
            this.OtherNameTypeDescriptor = otherNameTypeDescriptor ?? throw new ArgumentNullException("otherNameTypeDescriptor is a required property for EdFiParentOtherName and cannot be null");
            // to ensure "firstName" is required (not null)
            this.FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for EdFiParentOtherName and cannot be null");
            // to ensure "lastSurname" is required (not null)
            this.LastSurname = lastSurname ?? throw new ArgumentNullException("lastSurname is a required property for EdFiParentOtherName and cannot be null");
