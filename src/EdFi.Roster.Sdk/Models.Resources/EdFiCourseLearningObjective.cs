...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_courseLearningObjective")]
    public partial class EdFiCourseLearningObjective : IEquatable<EdFiCourseLearningObjective>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseLearningObjective" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiCourseLearningObjective() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiCourseLearningObjective" /> class.
        /// </summary>
        ...
        public EdFiCourseLearningObjective(EdFiLearningObjectiveReference learningObjectiveReference = default(EdFiLearningObjectiveReference))
        {
            ...
            this.LearningObjectiveReference = learningObjectiveReference ?? throw new ArgumentNullException("learningObjectiveReference is a required property for EdFiCourseLearningObjective and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiCourseLearningObjective);
        }

        /// <summary>
        /// Returns true if EdFiCourseLearningObjective instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseLearningObjective to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseLearningObjective input)
        {
            if (input == null)
                return false;
