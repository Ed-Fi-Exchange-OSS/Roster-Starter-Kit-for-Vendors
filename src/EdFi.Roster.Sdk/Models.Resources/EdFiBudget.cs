...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiBudget : IEquatable<EdFiBudget>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiBudget(string id = default(string), DateTime asOfDate = default(DateTime), EdFiAccountReference accountReference = default(EdFiAccountReference), double amount = default(double), string etag = default(string))
        {
            ...
            this.AccountReference = accountReference ?? throw new ArgumentNullException("accountReference is a required property for EdFiBudget and cannot be null");
            this.Amount = amount;
            this.Id = id;
            this.Etag = etag;
        }
