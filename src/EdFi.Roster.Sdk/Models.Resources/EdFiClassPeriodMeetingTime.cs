...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiClassPeriodMeetingTime : IEquatable<EdFiClassPeriodMeetingTime>, IValidatableObject
    {
        ...
        public EdFiClassPeriodMeetingTime(string endTime = default(string), string startTime = default(string))
        {
            ...
            this.EndTime = endTime ?? throw new ArgumentNullException("endTime is a required property for EdFiClassPeriodMeetingTime and cannot be null");
            // to ensure "startTime" is required (not null)
            this.StartTime = startTime ?? throw new ArgumentNullException("startTime is a required property for EdFiClassPeriodMeetingTime and cannot be null");
        }
