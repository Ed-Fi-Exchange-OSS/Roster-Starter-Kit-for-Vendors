...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_candidateDisability")]
    public partial class TpdmCandidateDisability : IEquatable<TpdmCandidateDisability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateDisability" /> class.
        /// </summary>
        ...
        public TpdmCandidateDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int orderOfDisability = default(int), List<TpdmCandidateDisabilityDesignation> designations = default(List<TpdmCandidateDisabilityDesignation>))
        {
            ...
            this.DisabilityDescriptor = disabilityDescriptor ?? throw new ArgumentNullException("disabilityDescriptor is a required property for TpdmCandidateDisability and cannot be null");
        ...
        /// </summary>
        /// <value>An unordered collection of candidateDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name = "designations", EmitDefaultValue = false)]
        public List<TpdmCandidateDisabilityDesignation> Designations { get; set; }
        ...
        /// <summary>
        /// Returns true if TpdmCandidateDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateDisability to be compared</param>
        /// <returns>Boolean</returns>
