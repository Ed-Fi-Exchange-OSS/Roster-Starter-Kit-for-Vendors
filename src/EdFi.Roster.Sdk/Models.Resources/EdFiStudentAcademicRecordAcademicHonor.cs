...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentAcademicRecordAcademicHonor : IEquatable<EdFiStudentAcademicRecordAcademicHonor>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentAcademicRecordAcademicHonor(string academicHonorCategoryDescriptor = default(string), string honorDescription = default(string), string achievementCategoryDescriptor = default(string), string achievementCategorySystem = default(string), string achievementTitle = default(string), string criteria = default(string), string criteriaURL = default(string), string evidenceStatement = default(string), DateTime honorAwardDate = default(DateTime), DateTime honorAwardExpiresDate = default(DateTime), string imageURL = default(string), string issuerName = default(string), string issuerOriginURL = default(string))
        {
            ...
            this.AcademicHonorCategoryDescriptor = academicHonorCategoryDescriptor ?? throw new ArgumentNullException("academicHonorCategoryDescriptor is a required property for EdFiStudentAcademicRecordAcademicHonor and cannot be null");
            // to ensure "honorDescription" is required (not null)
            this.HonorDescription = honorDescription ?? throw new ArgumentNullException("honorDescription is a required property for EdFiStudentAcademicRecordAcademicHonor and cannot be null");
        ...
        [DataMember(Name = "academicHonorCategoryDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "honorDescription", IsRequired = true, EmitDefaultValue = false)]
