...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiEducationOrganizationPeerAssociation : IEquatable<EdFiEducationOrganizationPeerAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiEducationOrganizationPeerAssociation(string id = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiEducationOrganizationReference peerEducationOrganizationReference = default(EdFiEducationOrganizationReference), string etag = default(string))
        {
            ...
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiEducationOrganizationPeerAssociation and cannot be null");
            // to ensure "peerEducationOrganizationReference" is required (not null)
            this.PeerEducationOrganizationReference = peerEducationOrganizationReference ?? throw new ArgumentNullException("peerEducationOrganizationReference is a required property for EdFiEducationOrganizationPeerAssociation and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
        ...
        /// </summary>
        [DataMember(Name = "peerEducationOrganizationReference", IsRequired = true, EmitDefaultValue = false)]
