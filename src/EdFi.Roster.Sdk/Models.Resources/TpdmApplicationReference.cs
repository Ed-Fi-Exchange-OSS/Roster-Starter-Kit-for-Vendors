...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_applicationReference")]
    public partial class TpdmApplicationReference : IEquatable<TpdmApplicationReference>, IValidatableObject
    {
        /// <summary>
        ...
        public TpdmApplicationReference(string applicantProfileIdentifier = default(string), string applicationIdentifier = default(string), int educationOrganizationId = default(int), Link link = default(Link))
        {
            // to ensure "applicantProfileIdentifier" is required (not null)
            this.ApplicantProfileIdentifier = applicantProfileIdentifier ?? throw new ArgumentNullException("applicantProfileIdentifier is a required property for TpdmApplicationReference and cannot be null");
            // to ensure "applicationIdentifier" is required (not null)
            this.ApplicationIdentifier = applicationIdentifier ?? throw new ArgumentNullException("applicationIdentifier is a required property for TpdmApplicationReference and cannot be null");
