...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_assessmentSection")]
    public partial class EdFiAssessmentSection : IEquatable<EdFiAssessmentSection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentSection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiAssessmentSection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiAssessmentSection" /> class.
        /// </summary>
        ...
        public EdFiAssessmentSection(EdFiSectionReference sectionReference = default(EdFiSectionReference))
        {
            ...
            this.SectionReference = sectionReference ?? throw new ArgumentNullException("sectionReference is a required property for EdFiAssessmentSection and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiAssessmentSection);
        }

        /// <summary>
        /// Returns true if EdFiAssessmentSection instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiAssessmentSection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiAssessmentSection input)
        {
            if (input == null)
                return false;
