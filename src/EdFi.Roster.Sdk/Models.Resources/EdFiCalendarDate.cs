...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCalendarDate : IEquatable<EdFiCalendarDate>, IValidatableObject
    {
        ...
        public EdFiCalendarDate(string id = default(string), List<EdFiCalendarDateCalendarEvent> calendarEvents = default(List<EdFiCalendarDateCalendarEvent>), DateTime date = default(DateTime), EdFiCalendarReference calendarReference = default(EdFiCalendarReference), string etag = default(string))
        {
            ...
            this.CalendarEvents = calendarEvents ?? throw new ArgumentNullException("calendarEvents is a required property for EdFiCalendarDate and cannot be null");
            this.Date = date;
            // to ensure "calendarReference" is required (not null)
            this.CalendarReference = calendarReference ?? throw new ArgumentNullException("calendarReference is a required property for EdFiCalendarDate and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
        ...
        [DataMember(Name = "calendarEvents", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "calendarReference", IsRequired = true, EmitDefaultValue = false)]
