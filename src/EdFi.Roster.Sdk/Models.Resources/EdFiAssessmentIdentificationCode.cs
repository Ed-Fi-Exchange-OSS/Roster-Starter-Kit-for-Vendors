...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAssessmentIdentificationCode : IEquatable<EdFiAssessmentIdentificationCode>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAssessmentIdentificationCode(string assessmentIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string identificationCode = default(string))
        {
            ...
            this.AssessmentIdentificationSystemDescriptor = assessmentIdentificationSystemDescriptor ?? throw new ArgumentNullException("assessmentIdentificationSystemDescriptor is a required property for EdFiAssessmentIdentificationCode and cannot be null");
            // to ensure "identificationCode" is required (not null)
            this.IdentificationCode = identificationCode ?? throw new ArgumentNullException("identificationCode is a required property for EdFiAssessmentIdentificationCode and cannot be null");
        ...
        [DataMember(Name = "assessmentIdentificationSystemDescriptor", IsRequired = true, EmitDefaultValue = false)]
