...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiEducationOrganizationInstitutionTelephone : IEquatable<EdFiEducationOrganizationInstitutionTelephone>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiEducationOrganizationInstitutionTelephone(string institutionTelephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string))
        {
            // to ensure "institutionTelephoneNumberTypeDescriptor" is required (not null)
            this.InstitutionTelephoneNumberTypeDescriptor = institutionTelephoneNumberTypeDescriptor ?? throw new ArgumentNullException("institutionTelephoneNumberTypeDescriptor is a required property for EdFiEducationOrganizationInstitutionTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for EdFiEducationOrganizationInstitutionTelephone and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiEducationOrganizationInstitutionTelephone);
        }

        /// <summary>
        /// Returns true if EdFiEducationOrganizationInstitutionTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiEducationOrganizationInstitutionTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiEducationOrganizationInstitutionTelephone input)
        {
            if (input == null)
                return false;
