...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_stateEducationAgency")]
    public partial class EdFiStateEducationAgency : IEquatable<EdFiStateEducationAgency>, IValidatableObject
    {
        ...
        public EdFiStateEducationAgency(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), int stateEducationAgencyId = default(int), List<EdFiStateEducationAgencyAccountability> accountabilities = default(List<EdFiStateEducationAgencyAccountability>), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiStateEducationAgencyFederalFunds> federalFunds = default(List<EdFiStateEducationAgencyFederalFunds>), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), string nameOfInstitution = default(string), string operationalStatusDescriptor = default(string), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string), StateEducationAgencyExtensions ext = default(StateEducationAgencyExtensions))
        {
            // to ensure "categories" is required (not null)
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for EdFiStateEducationAgency and cannot be null");
            this.StateEducationAgencyId = stateEducationAgencyId;
            // to ensure "nameOfInstitution" is required (not null)
            this.NameOfInstitution = nameOfInstitution ?? throw new ArgumentNullException("nameOfInstitution is a required property for EdFiStateEducationAgency and cannot be null");
            this.Id = id;
        ...
        public StateEducationAgencyExtensions Ext { get; set; }
