...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiStaffAddress
    /// </summary>
    [DataContract(Name = "edFi_staffAddress")]
    public partial class EdFiStaffAddress : IEquatable<EdFiStaffAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStaffAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffAddress" /> class.
        /// </summary>
        ...
        /// <param name="periods">An unordered collection of staffAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address..</param>
        public EdFiStaffAddress(string addressTypeDescriptor = default(string), string stateAbbreviationDescriptor = default(string), string city = default(string), string postalCode = default(string), string streetNumberName = default(string), string localeDescriptor = default(string), string apartmentRoomSuiteNumber = default(string), string buildingSiteNumber = default(string), string congressionalDistrict = default(string), string countyFIPSCode = default(string), bool doNotPublishIndicator = default(bool), string latitude = default(string), string longitude = default(string), string nameOfCounty = default(string), List<EdFiStaffAddressPeriod> periods = default(List<EdFiStaffAddressPeriod>))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiStaffAddress and cannot be null");
            // to ensure "stateAbbreviationDescriptor" is required (not null)
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor ?? throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for EdFiStaffAddress and cannot be null");
            // to ensure "city" is required (not null)
            this.City = city ?? throw new ArgumentNullException("city is a required property for EdFiStaffAddress and cannot be null");
            // to ensure "postalCode" is required (not null)
            this.PostalCode = postalCode ?? throw new ArgumentNullException("postalCode is a required property for EdFiStaffAddress and cannot be null");
            // to ensure "streetNumberName" is required (not null)
            this.StreetNumberName = streetNumberName ?? throw new ArgumentNullException("streetNumberName is a required property for EdFiStaffAddress and cannot be null");
        ...
        /// </summary>
        /// <value>An unordered collection of staffAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.</value>
        [DataMember(Name = "periods", EmitDefaultValue = false)]
        public List<EdFiStaffAddressPeriod> Periods { get; set; }
        ...
        {
            return this.Equals(input as EdFiStaffAddress);
        }

        /// <summary>
        /// Returns true if EdFiStaffAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffAddress input)
        {
            if (input == null)
                return false;
