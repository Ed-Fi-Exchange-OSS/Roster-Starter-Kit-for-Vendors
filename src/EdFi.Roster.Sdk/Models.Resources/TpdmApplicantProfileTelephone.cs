...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileTelephone")]
    public partial class TpdmApplicantProfileTelephone : IEquatable<TpdmApplicantProfileTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileTelephone" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool doNotPublishIndicator = default(bool), int orderOfPriority = default(int), bool textMessageCapabilityIndicator = default(bool))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for TpdmApplicantProfileTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for TpdmApplicantProfileTelephone and cannot be null");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileTelephone);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileTelephone input)
        {
            if (input == null)
                return false;
