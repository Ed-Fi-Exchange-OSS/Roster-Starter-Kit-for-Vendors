...
{
    /// <summary>
    /// TpdmRecruitmentEventAttendanceDisability
    /// </summary>
    [DataContract(Name = "tpdm_recruitmentEventAttendanceDisability")]
    public partial class TpdmRecruitmentEventAttendanceDisability : IEquatable<TpdmRecruitmentEventAttendanceDisability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendanceDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmRecruitmentEventAttendanceDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendanceDisability" /> class.
        /// </summary>
        ...
        /// <param name="designations">An unordered collection of recruitmentEventAttendanceDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation..</param>
        public TpdmRecruitmentEventAttendanceDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int orderOfDisability = default(int), List<TpdmRecruitmentEventAttendanceDisabilityDesignation> designations = default(List<TpdmRecruitmentEventAttendanceDisabilityDesignation>))
        {
            // to ensure "disabilityDescriptor" is required (not null)
            this.DisabilityDescriptor = disabilityDescriptor ?? throw new ArgumentNullException("disabilityDescriptor is a required property for TpdmRecruitmentEventAttendanceDisability and cannot be null");
        ...
        [DataMember(Name = "disabilityDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// <summary>
        /// An unordered collection of recruitmentEventAttendanceDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.
        /// </summary>
        /// <value>An unordered collection of recruitmentEventAttendanceDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name = "designations", EmitDefaultValue = false)]
        public List<TpdmRecruitmentEventAttendanceDisabilityDesignation> Designations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmRecruitmentEventAttendanceDisability {\n");
        ...
        {
            return this.Equals(input as TpdmRecruitmentEventAttendanceDisability);
        }

        /// <summary>
        /// Returns true if TpdmRecruitmentEventAttendanceDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmRecruitmentEventAttendanceDisability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmRecruitmentEventAttendanceDisability input)
        {
            if (input == null)
                return false;
