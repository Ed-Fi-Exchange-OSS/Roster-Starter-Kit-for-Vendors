...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentLanguageInstructionProgramAssociation : IEquatable<EdFiStudentLanguageInstructionProgramAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentLanguageInstructionProgramAssociation(string id = default(string), DateTime beginDate = default(DateTime), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiStudentReference studentReference = default(EdFiStudentReference), int dosage = default(int), DateTime endDate = default(DateTime), List<EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment> englishLanguageProficiencyAssessments = default(List<EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment>), bool englishLearnerParticipation = default(bool), List<EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService> languageInstructionProgramServices = default(List<EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService>), EdFiGeneralStudentProgramAssociationParticipationStatus participationStatus = default(EdFiGeneralStudentProgramAssociationParticipationStatus), List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus> programParticipationStatuses = default(List<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>), string reasonExitedDescriptor = default(string), bool servedOutsideOfRegularSession = default(bool), string etag = default(string))
        {
            ...
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiStudentLanguageInstructionProgramAssociation and cannot be null");
            // to ensure "programReference" is required (not null)
            this.ProgramReference = programReference ?? throw new ArgumentNullException("programReference is a required property for EdFiStudentLanguageInstructionProgramAssociation and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentLanguageInstructionProgramAssociation and cannot be null");
            this.Id = id;
            this.Dosage = dosage;
        ...
        public bool Equals(EdFiStudentLanguageInstructionProgramAssociation input)
        {
            ...
            return 
                ...
                (
                    ...
                    input.EnglishLanguageProficiencyAssessments != null &&
                ...
                (
                    ...
                    input.LanguageInstructionProgramServices != null &&
