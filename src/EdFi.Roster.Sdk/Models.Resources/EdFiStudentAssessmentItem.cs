...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentAssessmentItem : IEquatable<EdFiStudentAssessmentItem>, IValidatableObject
    {
        ...
        public EdFiStudentAssessmentItem(string assessmentItemResultDescriptor = default(string), string responseIndicatorDescriptor = default(string), string assessmentResponse = default(string), string descriptiveFeedback = default(string), double rawScoreResult = default(double), string timeAssessed = default(string), EdFiAssessmentItemReference assessmentItemReference = default(EdFiAssessmentItemReference))
        {
            ...
            this.AssessmentItemResultDescriptor = assessmentItemResultDescriptor ?? throw new ArgumentNullException("assessmentItemResultDescriptor is a required property for EdFiStudentAssessmentItem and cannot be null");
            // to ensure "assessmentItemReference" is required (not null)
            this.AssessmentItemReference = assessmentItemReference ?? throw new ArgumentNullException("assessmentItemReference is a required property for EdFiStudentAssessmentItem and cannot be null");
