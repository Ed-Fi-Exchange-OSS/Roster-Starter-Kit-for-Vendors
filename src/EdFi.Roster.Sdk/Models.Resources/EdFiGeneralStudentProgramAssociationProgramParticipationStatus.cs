...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGeneralStudentProgramAssociationProgramParticipationStatus : IEquatable<EdFiGeneralStudentProgramAssociationProgramParticipationStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiGeneralStudentProgramAssociationProgramParticipationStatus(string participationStatusDescriptor = default(string), DateTime statusBeginDate = default(DateTime), string designatedBy = default(string), DateTime statusEndDate = default(DateTime))
        {
            ...
            this.ParticipationStatusDescriptor = participationStatusDescriptor ?? throw new ArgumentNullException("participationStatusDescriptor is a required property for EdFiGeneralStudentProgramAssociationProgramParticipationStatus and cannot be null");
        ...
        [DataMember(Name = "participationStatusDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "statusBeginDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ParticipationStatusDescriptor, length must be less than 306.", new [] { "ParticipationStatusDescriptor" });
            }
