...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiBellSchedule : IEquatable<EdFiBellSchedule>, IValidatableObject
    {
        ...
        public EdFiBellSchedule(string id = default(string), string bellScheduleName = default(string), List<EdFiBellScheduleClassPeriod> classPeriods = default(List<EdFiBellScheduleClassPeriod>), EdFiSchoolReference schoolReference = default(EdFiSchoolReference), string alternateDayName = default(string), List<EdFiBellScheduleDate> dates = default(List<EdFiBellScheduleDate>), string endTime = default(string), List<EdFiBellScheduleGradeLevel> gradeLevels = default(List<EdFiBellScheduleGradeLevel>), string startTime = default(string), int totalInstructionalTime = default(int), string etag = default(string))
        {
            ...
            this.BellScheduleName = bellScheduleName ?? throw new ArgumentNullException("bellScheduleName is a required property for EdFiBellSchedule and cannot be null");
            // to ensure "classPeriods" is required (not null)
            this.ClassPeriods = classPeriods ?? throw new ArgumentNullException("classPeriods is a required property for EdFiBellSchedule and cannot be null");
            // to ensure "schoolReference" is required (not null)
            this.SchoolReference = schoolReference ?? throw new ArgumentNullException("schoolReference is a required property for EdFiBellSchedule and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "bellScheduleName", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "classPeriods", IsRequired = true, EmitDefaultValue = false)]
