...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationElementRatingReference")]
    public partial class TpdmEvaluationElementRatingReference : IEquatable<TpdmEvaluationElementRatingReference>, IValidatableObject
    {
        /// <summary>
        ...
        public TpdmEvaluationElementRatingReference(int educationOrganizationId = default(int), DateTime evaluationDate = default(DateTime), string evaluationElementTitle = default(string), string evaluationObjectiveTitle = default(string), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), string personId = default(string), int schoolYear = default(int), string sourceSystemDescriptor = default(string), string termDescriptor = default(string), Link link = default(Link))
        {
            ...
            this.EvaluationElementTitle = evaluationElementTitle ?? throw new ArgumentNullException("evaluationElementTitle is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "evaluationObjectiveTitle" is required (not null)
            this.EvaluationObjectiveTitle = evaluationObjectiveTitle ?? throw new ArgumentNullException("evaluationObjectiveTitle is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "evaluationPeriodDescriptor" is required (not null)
            this.EvaluationPeriodDescriptor = evaluationPeriodDescriptor ?? throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "evaluationTitle" is required (not null)
            this.EvaluationTitle = evaluationTitle ?? throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "performanceEvaluationTitle" is required (not null)
            this.PerformanceEvaluationTitle = performanceEvaluationTitle ?? throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "performanceEvaluationTypeDescriptor" is required (not null)
            this.PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor ?? throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "personId" is required (not null)
            this.PersonId = personId ?? throw new ArgumentNullException("personId is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            this.SchoolYear = schoolYear;
            // to ensure "sourceSystemDescriptor" is required (not null)
            this.SourceSystemDescriptor = sourceSystemDescriptor ?? throw new ArgumentNullException("sourceSystemDescriptor is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            // to ensure "termDescriptor" is required (not null)
            this.TermDescriptor = termDescriptor ?? throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationElementRatingReference and cannot be null");
            this.Link = link;
        }
