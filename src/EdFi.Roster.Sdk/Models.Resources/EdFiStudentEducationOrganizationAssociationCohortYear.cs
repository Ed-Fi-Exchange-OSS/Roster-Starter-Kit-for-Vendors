...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentEducationOrganizationAssociationCohortYear : IEquatable<EdFiStudentEducationOrganizationAssociationCohortYear>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentEducationOrganizationAssociationCohortYear(string cohortYearTypeDescriptor = default(string), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference))
        {
            ...
            this.CohortYearTypeDescriptor = cohortYearTypeDescriptor ?? throw new ArgumentNullException("cohortYearTypeDescriptor is a required property for EdFiStudentEducationOrganizationAssociationCohortYear and cannot be null");
            // to ensure "schoolYearTypeReference" is required (not null)
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for EdFiStudentEducationOrganizationAssociationCohortYear and cannot be null");
        }
