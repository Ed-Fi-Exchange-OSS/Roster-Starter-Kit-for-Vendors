...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentInterventionAssociationInterventionEffectiveness : IEquatable<EdFiStudentInterventionAssociationInterventionEffectiveness>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentInterventionAssociationInterventionEffectiveness(string diagnosisDescriptor = default(string), string gradeLevelDescriptor = default(string), string populationServedDescriptor = default(string), string interventionEffectivenessRatingDescriptor = default(string), int improvementIndex = default(int))
        {
            // to ensure "diagnosisDescriptor" is required (not null)
            this.DiagnosisDescriptor = diagnosisDescriptor ?? throw new ArgumentNullException("diagnosisDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            // to ensure "gradeLevelDescriptor" is required (not null)
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            // to ensure "populationServedDescriptor" is required (not null)
            this.PopulationServedDescriptor = populationServedDescriptor ?? throw new ArgumentNullException("populationServedDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
            // to ensure "interventionEffectivenessRatingDescriptor" is required (not null)
            this.InterventionEffectivenessRatingDescriptor = interventionEffectivenessRatingDescriptor ?? throw new ArgumentNullException("interventionEffectivenessRatingDescriptor is a required property for EdFiStudentInterventionAssociationInterventionEffectiveness and cannot be null");
        ...
        [DataMember(Name = "populationServedDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "interventionEffectivenessRatingDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as EdFiStudentInterventionAssociationInterventionEffectiveness);
        }

        /// <summary>
        /// Returns true if EdFiStudentInterventionAssociationInterventionEffectiveness instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentInterventionAssociationInterventionEffectiveness to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentInterventionAssociationInterventionEffectiveness input)
        {
            if (input == null)
                return false;
