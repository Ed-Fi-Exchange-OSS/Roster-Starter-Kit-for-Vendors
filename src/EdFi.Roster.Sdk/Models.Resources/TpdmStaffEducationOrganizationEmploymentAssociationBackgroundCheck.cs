...
{
    /// <summary>
    /// TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck
    /// </summary>
    [DataContract(Name = "tpdm_staffEducationOrganizationEmploymentAssociationBackgroundCheck")]
    public partial class TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck : IEquatable<TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck" /> class.
        /// </summary>
        ...
        public TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck(string backgroundCheckTypeDescriptor = default(string), string backgroundCheckStatusDescriptor = default(string), DateTime backgroundCheckCompletedDate = default(DateTime), DateTime backgroundCheckRequestedDate = default(DateTime), bool fingerprint = default(bool))
        {
            // to ensure "backgroundCheckTypeDescriptor" is required (not null)
            this.BackgroundCheckTypeDescriptor = backgroundCheckTypeDescriptor ?? throw new ArgumentNullException("backgroundCheckTypeDescriptor is a required property for TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck {\n");
        ...
        {
            return this.Equals(input as TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck);
        }

        /// <summary>
        /// Returns true if TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmStaffEducationOrganizationEmploymentAssociationBackgroundCheck input)
        {
            if (input == null)
                return false;
