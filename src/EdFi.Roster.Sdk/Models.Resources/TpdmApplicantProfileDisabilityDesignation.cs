...
{
    /// <summary>
    /// TpdmApplicantProfileDisabilityDesignation
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileDisabilityDesignation")]
    public partial class TpdmApplicantProfileDisabilityDesignation : IEquatable<TpdmApplicantProfileDisabilityDesignation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileDisabilityDesignation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileDisabilityDesignation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileDisabilityDesignation" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfileDisabilityDesignation(string disabilityDesignationDescriptor = default(string))
        {
            // to ensure "disabilityDesignationDescriptor" is required (not null)
            this.DisabilityDesignationDescriptor = disabilityDesignationDescriptor ?? throw new ArgumentNullException("disabilityDesignationDescriptor is a required property for TpdmApplicantProfileDisabilityDesignation and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileDisabilityDesignation {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileDisabilityDesignation);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileDisabilityDesignation instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileDisabilityDesignation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileDisabilityDesignation input)
        {
            if (input == null)
                return false;
