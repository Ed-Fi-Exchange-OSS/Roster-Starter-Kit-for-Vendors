...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel : IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), bool performanceLevelMet = default(bool))
        {
            // to ensure "assessmentReportingMethodDescriptor" is required (not null)
            this.AssessmentReportingMethodDescriptor = assessmentReportingMethodDescriptor ?? throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel and cannot be null");
            // to ensure "performanceLevelDescriptor" is required (not null)
            this.PerformanceLevelDescriptor = performanceLevelDescriptor ?? throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel and cannot be null");
        ...
        {
            return this.Equals(input as EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel);
        }

        /// <summary>
        /// Returns true if EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentAssessmentStudentObjectiveAssessmentPerformanceLevel input)
        {
            if (input == null)
                return false;
