...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiEducationOrganizationNetworkAssociation : IEquatable<EdFiEducationOrganizationNetworkAssociation>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationNetworkAssociation(string id = default(string), EdFiEducationOrganizationNetworkReference educationOrganizationNetworkReference = default(EdFiEducationOrganizationNetworkReference), EdFiEducationOrganizationReference memberEducationOrganizationReference = default(EdFiEducationOrganizationReference), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), string etag = default(string))
        {
            ...
            this.EducationOrganizationNetworkReference = educationOrganizationNetworkReference ?? throw new ArgumentNullException("educationOrganizationNetworkReference is a required property for EdFiEducationOrganizationNetworkAssociation and cannot be null");
            // to ensure "memberEducationOrganizationReference" is required (not null)
            this.MemberEducationOrganizationReference = memberEducationOrganizationReference ?? throw new ArgumentNullException("memberEducationOrganizationReference is a required property for EdFiEducationOrganizationNetworkAssociation and cannot be null");
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "educationOrganizationNetworkReference", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "memberEducationOrganizationReference", IsRequired = true, EmitDefaultValue = false)]
