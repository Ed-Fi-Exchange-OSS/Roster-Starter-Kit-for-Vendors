...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveyProgramAssociation : IEquatable<EdFiSurveyProgramAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiSurveyProgramAssociation(string id = default(string), EdFiProgramReference programReference = default(EdFiProgramReference), EdFiSurveyReference surveyReference = default(EdFiSurveyReference), string etag = default(string))
        {
            ...
            this.ProgramReference = programReference ?? throw new ArgumentNullException("programReference is a required property for EdFiSurveyProgramAssociation and cannot be null");
            // to ensure "surveyReference" is required (not null)
            this.SurveyReference = surveyReference ?? throw new ArgumentNullException("surveyReference is a required property for EdFiSurveyProgramAssociation and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
