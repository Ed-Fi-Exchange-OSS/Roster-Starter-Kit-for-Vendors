...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentDisciplineIncidentAssociation : IEquatable<EdFiStudentDisciplineIncidentAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentAssociation(string id = default(string), EdFiDisciplineIncidentReference disciplineIncidentReference = default(EdFiDisciplineIncidentReference), EdFiStudentReference studentReference = default(EdFiStudentReference), List<EdFiStudentDisciplineIncidentAssociationBehavior> behaviors = default(List<EdFiStudentDisciplineIncidentAssociationBehavior>), string studentParticipationCodeDescriptor = default(string), string etag = default(string))
        {
            ...
            this.DisciplineIncidentReference = disciplineIncidentReference ?? throw new ArgumentNullException("disciplineIncidentReference is a required property for EdFiStudentDisciplineIncidentAssociation and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentDisciplineIncidentAssociation and cannot be null");
            // to ensure "studentParticipationCodeDescriptor" is required (not null)
            this.StudentParticipationCodeDescriptor = studentParticipationCodeDescriptor ?? throw new ArgumentNullException("studentParticipationCodeDescriptor is a required property for EdFiStudentDisciplineIncidentAssociation and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "studentParticipationCodeDescriptor", IsRequired = true, EmitDefaultValue = false)]
