...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGraduationPlanCreditsByCourse : IEquatable<EdFiGraduationPlanCreditsByCourse>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiGraduationPlanCreditsByCourse(string courseSetName = default(string), string creditTypeDescriptor = default(string), string whenTakenGradeLevelDescriptor = default(string), double creditConversion = default(double), double credits = default(double), List<EdFiGraduationPlanCreditsByCourseCourse> courses = default(List<EdFiGraduationPlanCreditsByCourseCourse>))
        {
            ...
            this.CourseSetName = courseSetName ?? throw new ArgumentNullException("courseSetName is a required property for EdFiGraduationPlanCreditsByCourse and cannot be null");
            this.Credits = credits;
            // to ensure "courses" is required (not null)
            this.Courses = courses ?? throw new ArgumentNullException("courses is a required property for EdFiGraduationPlanCreditsByCourse and cannot be null");
        ...
        [DataMember(Name = "courseSetName", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "courses", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CourseSetName, length must be less than 120.", new [] { "CourseSetName" });
            }
