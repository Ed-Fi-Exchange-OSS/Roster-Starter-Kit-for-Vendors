...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentEducationOrganizationAssociationLanguage")]
    public partial class EdFiStudentEducationOrganizationAssociationLanguage : IEquatable<EdFiStudentEducationOrganizationAssociationLanguage>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentEducationOrganizationAssociationLanguage(string languageDescriptor = default(string), List<EdFiStudentEducationOrganizationAssociationLanguageUse> uses = default(List<EdFiStudentEducationOrganizationAssociationLanguageUse>))
        {
            ...
            this.LanguageDescriptor = languageDescriptor ?? throw new ArgumentNullException("languageDescriptor is a required property for EdFiStudentEducationOrganizationAssociationLanguage and cannot be null");
            this.Uses = uses;
        }
