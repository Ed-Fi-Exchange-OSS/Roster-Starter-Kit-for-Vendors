...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiAssessmentPerformanceLevel : IEquatable<EdFiAssessmentPerformanceLevel>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
            ...
            this.AssessmentReportingMethodDescriptor = assessmentReportingMethodDescriptor ?? throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiAssessmentPerformanceLevel and cannot be null");
            // to ensure "performanceLevelDescriptor" is required (not null)
            this.PerformanceLevelDescriptor = performanceLevelDescriptor ?? throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiAssessmentPerformanceLevel and cannot be null");
