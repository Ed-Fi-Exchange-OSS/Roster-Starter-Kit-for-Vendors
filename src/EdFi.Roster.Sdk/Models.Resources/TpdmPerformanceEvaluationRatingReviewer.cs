...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class TpdmPerformanceEvaluationRatingReviewer : IEquatable<TpdmPerformanceEvaluationRatingReviewer>, IValidatableObject
    {
        ...
        public TpdmPerformanceEvaluationRatingReviewer(string firstName = default(string), string lastSurname = default(string), EdFiPersonReference reviewerPersonReference = default(EdFiPersonReference), TpdmPerformanceEvaluationRatingReviewerReceivedTraining receivedTraining = default(TpdmPerformanceEvaluationRatingReviewerReceivedTraining))
        {
            ...
            this.FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for TpdmPerformanceEvaluationRatingReviewer and cannot be null");
            // to ensure "lastSurname" is required (not null)
            this.LastSurname = lastSurname ?? throw new ArgumentNullException("lastSurname is a required property for TpdmPerformanceEvaluationRatingReviewer and cannot be null");
