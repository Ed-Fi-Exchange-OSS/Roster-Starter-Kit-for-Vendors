...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_candidateBackgroundCheck")]
    public partial class TpdmCandidateBackgroundCheck : IEquatable<TpdmCandidateBackgroundCheck>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateBackgroundCheck" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateBackgroundCheck() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateBackgroundCheck" /> class.
        /// </summary>
        ...
        public TpdmCandidateBackgroundCheck(string backgroundCheckStatusDescriptor = default(string), string backgroundCheckTypeDescriptor = default(string), DateTime backgroundCheckCompletedDate = default(DateTime), DateTime backgroundCheckRequestedDate = default(DateTime), bool fingerprint = default(bool))
        {
            // to ensure "backgroundCheckTypeDescriptor" is required (not null)
            this.BackgroundCheckTypeDescriptor = backgroundCheckTypeDescriptor ?? throw new ArgumentNullException("backgroundCheckTypeDescriptor is a required property for TpdmCandidateBackgroundCheck and cannot be null");
        ...
        {
            return this.Equals(input as TpdmCandidateBackgroundCheck);
        }

        /// <summary>
        /// Returns true if TpdmCandidateBackgroundCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateBackgroundCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCandidateBackgroundCheck input)
        {
            if (input == null)
                return false;
