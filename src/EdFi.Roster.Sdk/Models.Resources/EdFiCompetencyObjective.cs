...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCompetencyObjective : IEquatable<EdFiCompetencyObjective>, IValidatableObject
    {
        ...
        public EdFiCompetencyObjective(string id = default(string), string objective = default(string), string objectiveGradeLevelDescriptor = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), string competencyObjectiveId = default(string), string description = default(string), string successCriteria = default(string), string etag = default(string))
        {
            ...
            this.Objective = objective ?? throw new ArgumentNullException("objective is a required property for EdFiCompetencyObjective and cannot be null");
            // to ensure "objectiveGradeLevelDescriptor" is required (not null)
            this.ObjectiveGradeLevelDescriptor = objectiveGradeLevelDescriptor ?? throw new ArgumentNullException("objectiveGradeLevelDescriptor is a required property for EdFiCompetencyObjective and cannot be null");
            // to ensure "educationOrganizationReference" is required (not null)
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiCompetencyObjective and cannot be null");
            this.Id = id;
