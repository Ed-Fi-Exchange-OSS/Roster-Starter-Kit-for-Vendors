...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_learningObjectiveLearningStandard")]
    public partial class EdFiLearningObjectiveLearningStandard : IEquatable<EdFiLearningObjectiveLearningStandard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningObjectiveLearningStandard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiLearningObjectiveLearningStandard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiLearningObjectiveLearningStandard" /> class.
        /// </summary>
        ...
        public EdFiLearningObjectiveLearningStandard(EdFiLearningStandardReference learningStandardReference = default(EdFiLearningStandardReference))
        {
            ...
            this.LearningStandardReference = learningStandardReference ?? throw new ArgumentNullException("learningStandardReference is a required property for EdFiLearningObjectiveLearningStandard and cannot be null");
        }
        ...
        {
            return this.Equals(input as EdFiLearningObjectiveLearningStandard);
        }

        /// <summary>
        /// Returns true if EdFiLearningObjectiveLearningStandard instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiLearningObjectiveLearningStandard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiLearningObjectiveLearningStandard input)
        {
            if (input == null)
                return false;
