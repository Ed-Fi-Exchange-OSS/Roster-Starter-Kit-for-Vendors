...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class TpdmCandidateTelephone : IEquatable<TpdmCandidateTelephone>, IValidatableObject
    {
        ...
        public TpdmCandidateTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool doNotPublishIndicator = default(bool), int orderOfPriority = default(int), bool textMessageCapabilityIndicator = default(bool))
        {
            ...
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for TpdmCandidateTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for TpdmCandidateTelephone and cannot be null");
