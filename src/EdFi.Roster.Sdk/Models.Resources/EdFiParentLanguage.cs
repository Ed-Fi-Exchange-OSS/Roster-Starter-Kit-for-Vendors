...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiParentLanguage
    /// </summary>
    [DataContract(Name = "edFi_parentLanguage")]
    public partial class EdFiParentLanguage : IEquatable<EdFiParentLanguage>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiParentLanguage(string languageDescriptor = default(string), List<EdFiParentLanguageUse> uses = default(List<EdFiParentLanguageUse>))
        {
            ...
            this.LanguageDescriptor = languageDescriptor ?? throw new ArgumentNullException("languageDescriptor is a required property for EdFiParentLanguage and cannot be null");
            this.Uses = uses;
        }
