...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveySectionResponseReference : IEquatable<EdFiSurveySectionResponseReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiSurveySectionResponseReference(string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string), string surveySectionTitle = default(string), Link link = default(Link))
        {
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiSurveySectionResponseReference and cannot be null");
            // to ensure "surveyIdentifier" is required (not null)
            this.SurveyIdentifier = surveyIdentifier ?? throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveySectionResponseReference and cannot be null");
            // to ensure "surveyResponseIdentifier" is required (not null)
            this.SurveyResponseIdentifier = surveyResponseIdentifier ?? throw new ArgumentNullException("surveyResponseIdentifier is a required property for EdFiSurveySectionResponseReference and cannot be null");
            // to ensure "surveySectionTitle" is required (not null)
            this.SurveySectionTitle = surveySectionTitle ?? throw new ArgumentNullException("surveySectionTitle is a required property for EdFiSurveySectionResponseReference and cannot be null");
            this.Link = link;
        }
        ...
        {
            return this.Equals(input as EdFiSurveySectionResponseReference);
        }

        /// <summary>
        /// Returns true if EdFiSurveySectionResponseReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSurveySectionResponseReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSurveySectionResponseReference input)
        {
            if (input == null)
                return false;
