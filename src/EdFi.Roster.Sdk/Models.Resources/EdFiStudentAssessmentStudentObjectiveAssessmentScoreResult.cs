...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult : IEquatable<EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult(string assessmentReportingMethodDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string result = default(string))
        {
            ...
            this.AssessmentReportingMethodDescriptor = assessmentReportingMethodDescriptor ?? throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult and cannot be null");
            // to ensure "resultDatatypeTypeDescriptor" is required (not null)
            this.ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor ?? throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult and cannot be null");
            // to ensure "result" is required (not null)
            this.Result = result ?? throw new ArgumentNullException("result is a required property for EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult and cannot be null");
        }
