...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStaffInternationalAddress : IEquatable<EdFiStaffInternationalAddress>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStaffInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), string latitude = default(string), string longitude = default(string))
        {
            // to ensure "addressTypeDescriptor" is required (not null)
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiStaffInternationalAddress and cannot be null");
            // to ensure "countryDescriptor" is required (not null)
            this.CountryDescriptor = countryDescriptor ?? throw new ArgumentNullException("countryDescriptor is a required property for EdFiStaffInternationalAddress and cannot be null");
            // to ensure "addressLine1" is required (not null)
            this.AddressLine1 = addressLine1 ?? throw new ArgumentNullException("addressLine1 is a required property for EdFiStaffInternationalAddress and cannot be null");
        ...
        {
            return this.Equals(input as EdFiStaffInternationalAddress);
        }

        /// <summary>
        /// Returns true if EdFiStaffInternationalAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffInternationalAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffInternationalAddress input)
        {
            if (input == null)
                return false;
