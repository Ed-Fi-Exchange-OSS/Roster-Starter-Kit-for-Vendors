...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentLearningObjectiveReference : IEquatable<EdFiStudentLearningObjectiveReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentLearningObjectiveReference(string gradingPeriodDescriptor = default(string), int gradingPeriodSchoolId = default(int), int gradingPeriodSchoolYear = default(int), int gradingPeriodSequence = default(int), string learningObjectiveId = default(string), string _namespace = default(string), string studentUniqueId = default(string), Link link = default(Link))
        {
            ...
            this.GradingPeriodDescriptor = gradingPeriodDescriptor ?? throw new ArgumentNullException("gradingPeriodDescriptor is a required property for EdFiStudentLearningObjectiveReference and cannot be null");
            ...
            this.LearningObjectiveId = learningObjectiveId ?? throw new ArgumentNullException("learningObjectiveId is a required property for EdFiStudentLearningObjectiveReference and cannot be null");
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiStudentLearningObjectiveReference and cannot be null");
            // to ensure "studentUniqueId" is required (not null)
            this.StudentUniqueId = studentUniqueId ?? throw new ArgumentNullException("studentUniqueId is a required property for EdFiStudentLearningObjectiveReference and cannot be null");
            this.Link = link;
        }
        ...
        [DataMember(Name = "learningObjectiveId", IsRequired = true, EmitDefaultValue = false)]
