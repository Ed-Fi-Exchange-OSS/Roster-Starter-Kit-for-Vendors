...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiLocalEducationAgency : IEquatable<EdFiLocalEducationAgency>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiLocalEducationAgency(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), int localEducationAgencyId = default(int), EdFiEducationServiceCenterReference educationServiceCenterReference = default(EdFiEducationServiceCenterReference), EdFiLocalEducationAgencyReference parentLocalEducationAgencyReference = default(EdFiLocalEducationAgencyReference), EdFiStateEducationAgencyReference stateEducationAgencyReference = default(EdFiStateEducationAgencyReference), List<EdFiLocalEducationAgencyAccountability> accountabilities = default(List<EdFiLocalEducationAgencyAccountability>), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), string charterStatusDescriptor = default(string), List<EdFiLocalEducationAgencyFederalFunds> federalFunds = default(List<EdFiLocalEducationAgencyFederalFunds>), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), string localEducationAgencyCategoryDescriptor = default(string), string nameOfInstitution = default(string), string operationalStatusDescriptor = default(string), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string), LocalEducationAgencyExtensions ext = default(LocalEducationAgencyExtensions))
        {
            ...
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for EdFiLocalEducationAgency and cannot be null");
            this.LocalEducationAgencyId = localEducationAgencyId;
            // to ensure "localEducationAgencyCategoryDescriptor" is required (not null)
            this.LocalEducationAgencyCategoryDescriptor = localEducationAgencyCategoryDescriptor ?? throw new ArgumentNullException("localEducationAgencyCategoryDescriptor is a required property for EdFiLocalEducationAgency and cannot be null");
            // to ensure "nameOfInstitution" is required (not null)
            this.NameOfInstitution = nameOfInstitution ?? throw new ArgumentNullException("nameOfInstitution is a required property for EdFiLocalEducationAgency and cannot be null");
            this.Id = id;
