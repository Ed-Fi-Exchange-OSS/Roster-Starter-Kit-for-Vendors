...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiEducationOrganizationNetwork : IEquatable<EdFiEducationOrganizationNetwork>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiEducationOrganizationNetwork(string id = default(string), List<EdFiEducationOrganizationCategory> categories = default(List<EdFiEducationOrganizationCategory>), int educationOrganizationNetworkId = default(int), List<EdFiEducationOrganizationAddress> addresses = default(List<EdFiEducationOrganizationAddress>), List<EdFiEducationOrganizationIdentificationCode> identificationCodes = default(List<EdFiEducationOrganizationIdentificationCode>), List<EdFiEducationOrganizationIndicator> indicators = default(List<EdFiEducationOrganizationIndicator>), List<EdFiEducationOrganizationInstitutionTelephone> institutionTelephones = default(List<EdFiEducationOrganizationInstitutionTelephone>), List<EdFiEducationOrganizationInternationalAddress> internationalAddresses = default(List<EdFiEducationOrganizationInternationalAddress>), string nameOfInstitution = default(string), string networkPurposeDescriptor = default(string), string operationalStatusDescriptor = default(string), string shortNameOfInstitution = default(string), string webSite = default(string), string etag = default(string))
        {
            ...
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for EdFiEducationOrganizationNetwork and cannot be null");
            this.EducationOrganizationNetworkId = educationOrganizationNetworkId;
            // to ensure "nameOfInstitution" is required (not null)
            this.NameOfInstitution = nameOfInstitution ?? throw new ArgumentNullException("nameOfInstitution is a required property for EdFiEducationOrganizationNetwork and cannot be null");
            // to ensure "networkPurposeDescriptor" is required (not null)
            this.NetworkPurposeDescriptor = networkPurposeDescriptor ?? throw new ArgumentNullException("networkPurposeDescriptor is a required property for EdFiEducationOrganizationNetwork and cannot be null");
            this.Id = id;
        ...
        [DataMember(Name = "networkPurposeDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NetworkPurposeDescriptor, length must be less than 306.", new [] { "NetworkPurposeDescriptor" });
            }
