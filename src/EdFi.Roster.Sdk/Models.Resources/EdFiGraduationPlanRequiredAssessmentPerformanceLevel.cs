...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_graduationPlanRequiredAssessmentPerformanceLevel")]
    public partial class EdFiGraduationPlanRequiredAssessmentPerformanceLevel : IEquatable<EdFiGraduationPlanRequiredAssessmentPerformanceLevel>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiGraduationPlanRequiredAssessmentPerformanceLevel(string assessmentReportingMethodDescriptor = default(string), string performanceLevelDescriptor = default(string), string resultDatatypeTypeDescriptor = default(string), string maximumScore = default(string), string minimumScore = default(string))
        {
            ...
            this.AssessmentReportingMethodDescriptor = assessmentReportingMethodDescriptor ?? throw new ArgumentNullException("assessmentReportingMethodDescriptor is a required property for EdFiGraduationPlanRequiredAssessmentPerformanceLevel and cannot be null");
            // to ensure "performanceLevelDescriptor" is required (not null)
            this.PerformanceLevelDescriptor = performanceLevelDescriptor ?? throw new ArgumentNullException("performanceLevelDescriptor is a required property for EdFiGraduationPlanRequiredAssessmentPerformanceLevel and cannot be null");
