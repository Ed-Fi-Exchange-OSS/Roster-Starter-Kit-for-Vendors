...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCourseTranscriptAlternativeCourseIdentificationCode : IEquatable<EdFiCourseTranscriptAlternativeCourseIdentificationCode>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiCourseTranscriptAlternativeCourseIdentificationCode(string courseIdentificationSystemDescriptor = default(string), string assigningOrganizationIdentificationCode = default(string), string courseCatalogURL = default(string), string identificationCode = default(string))
        {
            // to ensure "courseIdentificationSystemDescriptor" is required (not null)
            this.CourseIdentificationSystemDescriptor = courseIdentificationSystemDescriptor ?? throw new ArgumentNullException("courseIdentificationSystemDescriptor is a required property for EdFiCourseTranscriptAlternativeCourseIdentificationCode and cannot be null");
            // to ensure "identificationCode" is required (not null)
            this.IdentificationCode = identificationCode ?? throw new ArgumentNullException("identificationCode is a required property for EdFiCourseTranscriptAlternativeCourseIdentificationCode and cannot be null");
        ...
        {
            return this.Equals(input as EdFiCourseTranscriptAlternativeCourseIdentificationCode);
        }

        /// <summary>
        /// Returns true if EdFiCourseTranscriptAlternativeCourseIdentificationCode instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiCourseTranscriptAlternativeCourseIdentificationCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiCourseTranscriptAlternativeCourseIdentificationCode input)
        {
            if (input == null)
                return false;
