...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_bellScheduleGradeLevel")]
    public partial class EdFiBellScheduleGradeLevel : IEquatable<EdFiBellScheduleGradeLevel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiBellScheduleGradeLevel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiBellScheduleGradeLevel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiBellScheduleGradeLevel" /> class.
        /// </summary>
        /// <param name="gradeLevelDescriptor">The grade levels the particular BellSchedule applies to. (required).</param>
        public EdFiBellScheduleGradeLevel(string gradeLevelDescriptor = default(string))
        {
            // to ensure "gradeLevelDescriptor" is required (not null)
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiBellScheduleGradeLevel and cannot be null");
        }

        /// <summary>
        /// The grade levels the particular BellSchedule applies to.
        /// </summary>
        /// <value>The grade levels the particular BellSchedule applies to.</value>
        ...
        {
            return this.Equals(input as EdFiBellScheduleGradeLevel);
        }

        /// <summary>
        /// Returns true if EdFiBellScheduleGradeLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiBellScheduleGradeLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiBellScheduleGradeLevel input)
        {
            if (input == null)
                return false;
