...
{
    /// <summary>
    /// TpdmApplicantProfileDisability
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfileDisability")]
    public partial class TpdmApplicantProfileDisability : IEquatable<TpdmApplicantProfileDisability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileDisability" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfileDisability() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfileDisability" /> class.
        /// </summary>
        ...
        /// <param name="designations">An unordered collection of applicantProfileDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation..</param>
        public TpdmApplicantProfileDisability(string disabilityDescriptor = default(string), string disabilityDeterminationSourceTypeDescriptor = default(string), string disabilityDiagnosis = default(string), int orderOfDisability = default(int), List<TpdmApplicantProfileDisabilityDesignation> designations = default(List<TpdmApplicantProfileDisabilityDesignation>))
        {
            // to ensure "disabilityDescriptor" is required (not null)
            this.DisabilityDescriptor = disabilityDescriptor ?? throw new ArgumentNullException("disabilityDescriptor is a required property for TpdmApplicantProfileDisability and cannot be null");
        ...
        /// <summary>
        /// An unordered collection of applicantProfileDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.
        /// </summary>
        /// <value>An unordered collection of applicantProfileDisabilityDesignations. Whether the disability is IDEA, Section 504, or other disability designation.</value>
        [DataMember(Name = "designations", EmitDefaultValue = false)]
        public List<TpdmApplicantProfileDisabilityDesignation> Designations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfileDisability {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfileDisability);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfileDisability instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfileDisability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfileDisability input)
        {
            if (input == null)
                return false;
