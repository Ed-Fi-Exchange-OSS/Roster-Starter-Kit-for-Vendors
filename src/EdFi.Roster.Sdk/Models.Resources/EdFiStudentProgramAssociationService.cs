...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentProgramAssociationService")]
    public partial class EdFiStudentProgramAssociationService : IEquatable<EdFiStudentProgramAssociationService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentProgramAssociationService" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStudentProgramAssociationService() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStudentProgramAssociationService" /> class.
        /// </summary>
        ...
        public EdFiStudentProgramAssociationService(string serviceDescriptor = default(string), bool primaryIndicator = default(bool), DateTime serviceBeginDate = default(DateTime), DateTime serviceEndDate = default(DateTime))
        {
            // to ensure "serviceDescriptor" is required (not null)
            this.ServiceDescriptor = serviceDescriptor ?? throw new ArgumentNullException("serviceDescriptor is a required property for EdFiStudentProgramAssociationService and cannot be null");
        ...
        [DataMember(Name = "serviceDescriptor", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as EdFiStudentProgramAssociationService);
        }

        /// <summary>
        /// Returns true if EdFiStudentProgramAssociationService instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStudentProgramAssociationService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStudentProgramAssociationService input)
        {
            if (input == null)
                return false;
