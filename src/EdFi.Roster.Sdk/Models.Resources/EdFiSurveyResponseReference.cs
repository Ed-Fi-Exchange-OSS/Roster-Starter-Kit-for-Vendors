...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveyResponseReference : IEquatable<EdFiSurveyResponseReference>, IValidatableObject
    {
        ...
        public EdFiSurveyResponseReference(string _namespace = default(string), string surveyIdentifier = default(string), string surveyResponseIdentifier = default(string), Link link = default(Link))
        {
            ...
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiSurveyResponseReference and cannot be null");
            // to ensure "surveyIdentifier" is required (not null)
            this.SurveyIdentifier = surveyIdentifier ?? throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveyResponseReference and cannot be null");
            // to ensure "surveyResponseIdentifier" is required (not null)
            this.SurveyResponseIdentifier = surveyResponseIdentifier ?? throw new ArgumentNullException("surveyResponseIdentifier is a required property for EdFiSurveyResponseReference and cannot be null");
            this.Link = link;
        }
