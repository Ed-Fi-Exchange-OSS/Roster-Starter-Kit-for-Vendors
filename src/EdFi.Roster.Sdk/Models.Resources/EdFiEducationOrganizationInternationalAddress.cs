...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_educationOrganizationInternationalAddress")]
    public partial class EdFiEducationOrganizationInternationalAddress : IEquatable<EdFiEducationOrganizationInternationalAddress>, IValidatableObject
    {
        ...
        public EdFiEducationOrganizationInternationalAddress(string addressTypeDescriptor = default(string), string countryDescriptor = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), DateTime beginDate = default(DateTime), DateTime endDate = default(DateTime), string latitude = default(string), string longitude = default(string))
        {
            ...
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for EdFiEducationOrganizationInternationalAddress and cannot be null");
            // to ensure "countryDescriptor" is required (not null)
            this.CountryDescriptor = countryDescriptor ?? throw new ArgumentNullException("countryDescriptor is a required property for EdFiEducationOrganizationInternationalAddress and cannot be null");
            // to ensure "addressLine1" is required (not null)
            this.AddressLine1 = addressLine1 ?? throw new ArgumentNullException("addressLine1 is a required property for EdFiEducationOrganizationInternationalAddress and cannot be null");
