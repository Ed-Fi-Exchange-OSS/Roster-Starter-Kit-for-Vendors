...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentSectionAttendanceEvent : IEquatable<EdFiStudentSectionAttendanceEvent>, IValidatableObject
    {
        ...
        public EdFiStudentSectionAttendanceEvent(string id = default(string), string attendanceEventCategoryDescriptor = default(string), DateTime eventDate = default(DateTime), EdFiSectionReference sectionReference = default(EdFiSectionReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string arrivalTime = default(string), string attendanceEventReason = default(string), string departureTime = default(string), string educationalEnvironmentDescriptor = default(string), double eventDuration = default(double), int sectionAttendanceDuration = default(int), string etag = default(string))
        {
            ...
            this.AttendanceEventCategoryDescriptor = attendanceEventCategoryDescriptor ?? throw new ArgumentNullException("attendanceEventCategoryDescriptor is a required property for EdFiStudentSectionAttendanceEvent and cannot be null");
            this.EventDate = eventDate;
            // to ensure "sectionReference" is required (not null)
            this.SectionReference = sectionReference ?? throw new ArgumentNullException("sectionReference is a required property for EdFiStudentSectionAttendanceEvent and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentSectionAttendanceEvent and cannot be null");
            this.Id = id;
