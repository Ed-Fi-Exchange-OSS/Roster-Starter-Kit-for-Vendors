...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentOtherName : IEquatable<EdFiStudentOtherName>, IValidatableObject
    {
        ...
        public EdFiStudentOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            ...
            this.OtherNameTypeDescriptor = otherNameTypeDescriptor ?? throw new ArgumentNullException("otherNameTypeDescriptor is a required property for EdFiStudentOtherName and cannot be null");
            // to ensure "firstName" is required (not null)
            this.FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for EdFiStudentOtherName and cannot be null");
            // to ensure "lastSurname" is required (not null)
            this.LastSurname = lastSurname ?? throw new ArgumentNullException("lastSurname is a required property for EdFiStudentOtherName and cannot be null");
