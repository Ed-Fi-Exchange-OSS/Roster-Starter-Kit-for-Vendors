...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentDisciplineIncidentBehaviorAssociation : IEquatable<EdFiStudentDisciplineIncidentBehaviorAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentDisciplineIncidentBehaviorAssociation(string id = default(string), string behaviorDescriptor = default(string), EdFiDisciplineIncidentReference disciplineIncidentReference = default(EdFiDisciplineIncidentReference), EdFiStudentReference studentReference = default(EdFiStudentReference), string behaviorDetailedDescription = default(string), List<EdFiStudentDisciplineIncidentBehaviorAssociationDisciplineIncidentParticipationCode> disciplineIncidentParticipationCodes = default(List<EdFiStudentDisciplineIncidentBehaviorAssociationDisciplineIncidentParticipationCode>), string etag = default(string))
        {
            ...
            this.BehaviorDescriptor = behaviorDescriptor ?? throw new ArgumentNullException("behaviorDescriptor is a required property for EdFiStudentDisciplineIncidentBehaviorAssociation and cannot be null");
            // to ensure "disciplineIncidentReference" is required (not null)
            this.DisciplineIncidentReference = disciplineIncidentReference ?? throw new ArgumentNullException("disciplineIncidentReference is a required property for EdFiStudentDisciplineIncidentBehaviorAssociation and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentDisciplineIncidentBehaviorAssociation and cannot be null");
            this.Id = id;
