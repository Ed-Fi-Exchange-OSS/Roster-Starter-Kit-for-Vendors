...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_evaluationReference")]
    public partial class TpdmEvaluationReference : IEquatable<TpdmEvaluationReference>, IValidatableObject
    {
        /// <summary>
        ...
        public TpdmEvaluationReference(int educationOrganizationId = default(int), string evaluationPeriodDescriptor = default(string), string evaluationTitle = default(string), string performanceEvaluationTitle = default(string), string performanceEvaluationTypeDescriptor = default(string), int schoolYear = default(int), string termDescriptor = default(string), Link link = default(Link))
        {
            ...
            this.EvaluationPeriodDescriptor = evaluationPeriodDescriptor ?? throw new ArgumentNullException("evaluationPeriodDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            // to ensure "evaluationTitle" is required (not null)
            this.EvaluationTitle = evaluationTitle ?? throw new ArgumentNullException("evaluationTitle is a required property for TpdmEvaluationReference and cannot be null");
            // to ensure "performanceEvaluationTitle" is required (not null)
            this.PerformanceEvaluationTitle = performanceEvaluationTitle ?? throw new ArgumentNullException("performanceEvaluationTitle is a required property for TpdmEvaluationReference and cannot be null");
            // to ensure "performanceEvaluationTypeDescriptor" is required (not null)
            this.PerformanceEvaluationTypeDescriptor = performanceEvaluationTypeDescriptor ?? throw new ArgumentNullException("performanceEvaluationTypeDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            this.SchoolYear = schoolYear;
            // to ensure "termDescriptor" is required (not null)
            this.TermDescriptor = termDescriptor ?? throw new ArgumentNullException("termDescriptor is a required property for TpdmEvaluationReference and cannot be null");
            this.Link = link;
        }
