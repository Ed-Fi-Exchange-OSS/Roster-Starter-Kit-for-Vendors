...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiStaffTelephone
    /// </summary>
    [DataContract(Name = "edFi_staffTelephone")]
    public partial class EdFiStaffTelephone : IEquatable<EdFiStaffTelephone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffTelephone" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiStaffTelephone() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiStaffTelephone" /> class.
        /// </summary>
        ...
        public EdFiStaffTelephone(string telephoneNumberTypeDescriptor = default(string), string telephoneNumber = default(string), bool doNotPublishIndicator = default(bool), int orderOfPriority = default(int), bool textMessageCapabilityIndicator = default(bool))
        {
            // to ensure "telephoneNumberTypeDescriptor" is required (not null)
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for EdFiStaffTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for EdFiStaffTelephone and cannot be null");
        ...
        {
            return this.Equals(input as EdFiStaffTelephone);
        }

        /// <summary>
        /// Returns true if EdFiStaffTelephone instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiStaffTelephone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiStaffTelephone input)
        {
            if (input == null)
                return false;
