...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiGraduationPlanReference : IEquatable<EdFiGraduationPlanReference>, IValidatableObject
    {
        ...
        public EdFiGraduationPlanReference(int educationOrganizationId = default(int), string graduationPlanTypeDescriptor = default(string), int graduationSchoolYear = default(int), Link link = default(Link))
        {
            ...
            this.GraduationPlanTypeDescriptor = graduationPlanTypeDescriptor ?? throw new ArgumentNullException("graduationPlanTypeDescriptor is a required property for EdFiGraduationPlanReference and cannot be null");
        ...
        [DataMember(Name = "graduationSchoolYear", IsRequired = true, EmitDefaultValue = false)]
