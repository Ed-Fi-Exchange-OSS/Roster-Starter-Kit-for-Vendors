...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiStudentEducationOrganizationResponsibilityAssociation : IEquatable<EdFiStudentEducationOrganizationResponsibilityAssociation>, IValidatableObject
    {
        ...
        public EdFiStudentEducationOrganizationResponsibilityAssociation(string id = default(string), DateTime beginDate = default(DateTime), string responsibilityDescriptor = default(string), EdFiEducationOrganizationReference educationOrganizationReference = default(EdFiEducationOrganizationReference), EdFiStudentReference studentReference = default(EdFiStudentReference), DateTime endDate = default(DateTime), string etag = default(string))
        {
            ...
            this.ResponsibilityDescriptor = responsibilityDescriptor ?? throw new ArgumentNullException("responsibilityDescriptor is a required property for EdFiStudentEducationOrganizationResponsibilityAssociation and cannot be null");
            // to ensure "educationOrganizationReference" is required (not null)
            this.EducationOrganizationReference = educationOrganizationReference ?? throw new ArgumentNullException("educationOrganizationReference is a required property for EdFiStudentEducationOrganizationResponsibilityAssociation and cannot be null");
            // to ensure "studentReference" is required (not null)
            this.StudentReference = studentReference ?? throw new ArgumentNullException("studentReference is a required property for EdFiStudentEducationOrganizationResponsibilityAssociation and cannot be null");
            this.Id = id;
