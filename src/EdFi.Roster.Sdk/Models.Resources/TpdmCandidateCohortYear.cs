...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_candidateCohortYear")]
    public partial class TpdmCandidateCohortYear : IEquatable<TpdmCandidateCohortYear>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateCohortYear" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateCohortYear() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateCohortYear" /> class.
        /// </summary>
        ...
        public TpdmCandidateCohortYear(string cohortYearTypeDescriptor = default(string), EdFiSchoolYearTypeReference schoolYearTypeReference = default(EdFiSchoolYearTypeReference))
        {
            // to ensure "cohortYearTypeDescriptor" is required (not null)
            this.CohortYearTypeDescriptor = cohortYearTypeDescriptor ?? throw new ArgumentNullException("cohortYearTypeDescriptor is a required property for TpdmCandidateCohortYear and cannot be null");
            // to ensure "schoolYearTypeReference" is required (not null)
            this.SchoolYearTypeReference = schoolYearTypeReference ?? throw new ArgumentNullException("schoolYearTypeReference is a required property for TpdmCandidateCohortYear and cannot be null");
        }
        ...
        {
            return this.Equals(input as TpdmCandidateCohortYear);
        }

        /// <summary>
        /// Returns true if TpdmCandidateCohortYear instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateCohortYear to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCandidateCohortYear input)
        {
            if (input == null)
                return false;
