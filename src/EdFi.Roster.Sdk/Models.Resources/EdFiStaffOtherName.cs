...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// EdFiStaffOtherName
    /// </summary>
    [DataContract(Name = "edFi_staffOtherName")]
    public partial class EdFiStaffOtherName : IEquatable<EdFiStaffOtherName>, IValidatableObject
    {
        ...
        public EdFiStaffOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            ...
            this.OtherNameTypeDescriptor = otherNameTypeDescriptor ?? throw new ArgumentNullException("otherNameTypeDescriptor is a required property for EdFiStaffOtherName and cannot be null");
            // to ensure "firstName" is required (not null)
            this.FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for EdFiStaffOtherName and cannot be null");
            // to ensure "lastSurname" is required (not null)
            this.LastSurname = lastSurname ?? throw new ArgumentNullException("lastSurname is a required property for EdFiStaffOtherName and cannot be null");
