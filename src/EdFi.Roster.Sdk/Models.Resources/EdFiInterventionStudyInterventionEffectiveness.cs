...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiInterventionStudyInterventionEffectiveness : IEquatable<EdFiInterventionStudyInterventionEffectiveness>, IValidatableObject
    {
        ...
        public EdFiInterventionStudyInterventionEffectiveness(string diagnosisDescriptor = default(string), string gradeLevelDescriptor = default(string), string populationServedDescriptor = default(string), string interventionEffectivenessRatingDescriptor = default(string), int improvementIndex = default(int))
        {
            ...
            this.DiagnosisDescriptor = diagnosisDescriptor ?? throw new ArgumentNullException("diagnosisDescriptor is a required property for EdFiInterventionStudyInterventionEffectiveness and cannot be null");
            // to ensure "gradeLevelDescriptor" is required (not null)
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for EdFiInterventionStudyInterventionEffectiveness and cannot be null");
            // to ensure "populationServedDescriptor" is required (not null)
            this.PopulationServedDescriptor = populationServedDescriptor ?? throw new ArgumentNullException("populationServedDescriptor is a required property for EdFiInterventionStudyInterventionEffectiveness and cannot be null");
            // to ensure "interventionEffectivenessRatingDescriptor" is required (not null)
            this.InterventionEffectivenessRatingDescriptor = interventionEffectivenessRatingDescriptor ?? throw new ArgumentNullException("interventionEffectivenessRatingDescriptor is a required property for EdFiInterventionStudyInterventionEffectiveness and cannot be null");
