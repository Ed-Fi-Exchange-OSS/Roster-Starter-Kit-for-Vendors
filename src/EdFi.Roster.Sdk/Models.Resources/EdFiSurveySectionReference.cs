...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_surveySectionReference")]
    public partial class EdFiSurveySectionReference : IEquatable<EdFiSurveySectionReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveySectionReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdFiSurveySectionReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiSurveySectionReference" /> class.
        /// </summary>
        ...
        public EdFiSurveySectionReference(string _namespace = default(string), string surveyIdentifier = default(string), string surveySectionTitle = default(string), Link link = default(Link))
        {
            // to ensure "_namespace" is required (not null)
            this.Namespace = _namespace ?? throw new ArgumentNullException("_namespace is a required property for EdFiSurveySectionReference and cannot be null");
            // to ensure "surveyIdentifier" is required (not null)
            this.SurveyIdentifier = surveyIdentifier ?? throw new ArgumentNullException("surveyIdentifier is a required property for EdFiSurveySectionReference and cannot be null");
            // to ensure "surveySectionTitle" is required (not null)
            this.SurveySectionTitle = surveySectionTitle ?? throw new ArgumentNullException("surveySectionTitle is a required property for EdFiSurveySectionReference and cannot be null");
            this.Link = link;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EdFiSurveySectionReference {\n");
        ...
        {
            return this.Equals(input as EdFiSurveySectionReference);
        }

        /// <summary>
        /// Returns true if EdFiSurveySectionReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EdFiSurveySectionReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdFiSurveySectionReference input)
        {
            if (input == null)
                return false;
