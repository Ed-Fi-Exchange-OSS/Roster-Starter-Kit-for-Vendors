...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiInterventionReference : IEquatable<EdFiInterventionReference>, IValidatableObject
    {
        ...
        public EdFiInterventionReference(int educationOrganizationId = default(int), string interventionIdentificationCode = default(string), Link link = default(Link))
        {
            ...
            this.InterventionIdentificationCode = interventionIdentificationCode ?? throw new ArgumentNullException("interventionIdentificationCode is a required property for EdFiInterventionReference and cannot be null");
            this.Link = link;
        }
