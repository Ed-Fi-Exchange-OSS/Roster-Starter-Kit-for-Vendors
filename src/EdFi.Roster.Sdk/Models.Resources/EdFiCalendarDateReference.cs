...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiCalendarDateReference : IEquatable<EdFiCalendarDateReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiCalendarDateReference(string calendarCode = default(string), DateTime date = default(DateTime), int schoolId = default(int), int schoolYear = default(int), Link link = default(Link))
        {
            ...
            this.CalendarCode = calendarCode ?? throw new ArgumentNullException("calendarCode is a required property for EdFiCalendarDateReference and cannot be null");
            this.Date = date;
