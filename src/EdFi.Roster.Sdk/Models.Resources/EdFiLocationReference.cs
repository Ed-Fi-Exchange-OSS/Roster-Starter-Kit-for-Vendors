...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiLocationReference : IEquatable<EdFiLocationReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiLocationReference(string classroomIdentificationCode = default(string), int schoolId = default(int), Link link = default(Link))
        {
            ...
            this.ClassroomIdentificationCode = classroomIdentificationCode ?? throw new ArgumentNullException("classroomIdentificationCode is a required property for EdFiLocationReference and cannot be null");
