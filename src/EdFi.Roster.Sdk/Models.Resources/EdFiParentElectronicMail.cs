...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_parentElectronicMail")]
    public partial class EdFiParentElectronicMail : IEquatable<EdFiParentElectronicMail>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiParentElectronicMail(string electronicMailTypeDescriptor = default(string), string electronicMailAddress = default(string), bool doNotPublishIndicator = default(bool), bool primaryEmailAddressIndicator = default(bool))
        {
            ...
            this.ElectronicMailTypeDescriptor = electronicMailTypeDescriptor ?? throw new ArgumentNullException("electronicMailTypeDescriptor is a required property for EdFiParentElectronicMail and cannot be null");
            // to ensure "electronicMailAddress" is required (not null)
            this.ElectronicMailAddress = electronicMailAddress ?? throw new ArgumentNullException("electronicMailAddress is a required property for EdFiParentElectronicMail and cannot be null");
