...
{
    /// <summary>
    /// TpdmApplicantProfilePersonalIdentificationDocument
    /// </summary>
    [DataContract(Name = "tpdm_applicantProfilePersonalIdentificationDocument")]
    public partial class TpdmApplicantProfilePersonalIdentificationDocument : IEquatable<TpdmApplicantProfilePersonalIdentificationDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfilePersonalIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmApplicantProfilePersonalIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmApplicantProfilePersonalIdentificationDocument" /> class.
        /// </summary>
        ...
        public TpdmApplicantProfilePersonalIdentificationDocument(string identificationDocumentUseDescriptor = default(string), string personalInformationVerificationDescriptor = default(string), string issuerCountryDescriptor = default(string), DateTime documentExpirationDate = default(DateTime), string documentTitle = default(string), string issuerDocumentIdentificationCode = default(string), string issuerName = default(string))
        {
            // to ensure "identificationDocumentUseDescriptor" is required (not null)
            this.IdentificationDocumentUseDescriptor = identificationDocumentUseDescriptor ?? throw new ArgumentNullException("identificationDocumentUseDescriptor is a required property for TpdmApplicantProfilePersonalIdentificationDocument and cannot be null");
            // to ensure "personalInformationVerificationDescriptor" is required (not null)
            this.PersonalInformationVerificationDescriptor = personalInformationVerificationDescriptor ?? throw new ArgumentNullException("personalInformationVerificationDescriptor is a required property for TpdmApplicantProfilePersonalIdentificationDocument and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmApplicantProfilePersonalIdentificationDocument {\n");
        ...
        {
            return this.Equals(input as TpdmApplicantProfilePersonalIdentificationDocument);
        }

        /// <summary>
        /// Returns true if TpdmApplicantProfilePersonalIdentificationDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmApplicantProfilePersonalIdentificationDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmApplicantProfilePersonalIdentificationDocument input)
        {
            if (input == null)
                return false;
