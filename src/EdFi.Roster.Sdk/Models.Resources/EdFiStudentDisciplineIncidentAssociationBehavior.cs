...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_studentDisciplineIncidentAssociationBehavior")]
    public partial class EdFiStudentDisciplineIncidentAssociationBehavior : IEquatable<EdFiStudentDisciplineIncidentAssociationBehavior>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiStudentDisciplineIncidentAssociationBehavior(string behaviorDescriptor = default(string), string behaviorDetailedDescription = default(string))
        {
            ...
            this.BehaviorDescriptor = behaviorDescriptor ?? throw new ArgumentNullException("behaviorDescriptor is a required property for EdFiStudentDisciplineIncidentAssociationBehavior and cannot be null");
