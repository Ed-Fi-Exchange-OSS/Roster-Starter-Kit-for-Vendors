...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class EdFiSurveyResponseStaffTargetAssociation : IEquatable<EdFiSurveyResponseStaffTargetAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        public EdFiSurveyResponseStaffTargetAssociation(string id = default(string), EdFiStaffReference staffReference = default(EdFiStaffReference), EdFiSurveyResponseReference surveyResponseReference = default(EdFiSurveyResponseReference), string etag = default(string))
        {
            ...
            this.StaffReference = staffReference ?? throw new ArgumentNullException("staffReference is a required property for EdFiSurveyResponseStaffTargetAssociation and cannot be null");
            // to ensure "surveyResponseReference" is required (not null)
            this.SurveyResponseReference = surveyResponseReference ?? throw new ArgumentNullException("surveyResponseReference is a required property for EdFiSurveyResponseStaffTargetAssociation and cannot be null");
            this.Id = id;
            this.Etag = etag;
        }
