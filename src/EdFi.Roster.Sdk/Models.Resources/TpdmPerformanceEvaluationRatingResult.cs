...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    public partial class TpdmPerformanceEvaluationRatingResult : IEquatable<TpdmPerformanceEvaluationRatingResult>, IValidatableObject
    {
        ...
        public TpdmPerformanceEvaluationRatingResult(double rating = default(double), string ratingResultTitle = default(string), string resultDatatypeTypeDescriptor = default(string))
        {
            this.Rating = rating;
            // to ensure "ratingResultTitle" is required (not null)
            this.RatingResultTitle = ratingResultTitle ?? throw new ArgumentNullException("ratingResultTitle is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
            // to ensure "resultDatatypeTypeDescriptor" is required (not null)
            this.ResultDatatypeTypeDescriptor = resultDatatypeTypeDescriptor ?? throw new ArgumentNullException("resultDatatypeTypeDescriptor is a required property for TpdmPerformanceEvaluationRatingResult and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmPerformanceEvaluationRatingResult {\n");
        ...
        {
            return this.Equals(input as TpdmPerformanceEvaluationRatingResult);
        }
