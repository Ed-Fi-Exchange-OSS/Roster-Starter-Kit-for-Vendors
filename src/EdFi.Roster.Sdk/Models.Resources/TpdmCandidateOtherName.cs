...
namespace EdFi.Roster.Sdk.Models.Resources
{
    ...
    /// </summary>
    [DataContract(Name = "tpdm_candidateOtherName")]
    public partial class TpdmCandidateOtherName : IEquatable<TpdmCandidateOtherName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateOtherName" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmCandidateOtherName() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmCandidateOtherName" /> class.
        /// </summary>
        ...
        public TpdmCandidateOtherName(string otherNameTypeDescriptor = default(string), string firstName = default(string), string generationCodeSuffix = default(string), string lastSurname = default(string), string middleName = default(string), string personalTitlePrefix = default(string))
        {
            // to ensure "otherNameTypeDescriptor" is required (not null)
            this.OtherNameTypeDescriptor = otherNameTypeDescriptor ?? throw new ArgumentNullException("otherNameTypeDescriptor is a required property for TpdmCandidateOtherName and cannot be null");
            // to ensure "firstName" is required (not null)
            this.FirstName = firstName ?? throw new ArgumentNullException("firstName is a required property for TpdmCandidateOtherName and cannot be null");
            // to ensure "lastSurname" is required (not null)
            this.LastSurname = lastSurname ?? throw new ArgumentNullException("lastSurname is a required property for TpdmCandidateOtherName and cannot be null");
        ...
        {
            return this.Equals(input as TpdmCandidateOtherName);
        }

        /// <summary>
        /// Returns true if TpdmCandidateOtherName instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmCandidateOtherName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmCandidateOtherName input)
        {
            if (input == null)
                return false;
