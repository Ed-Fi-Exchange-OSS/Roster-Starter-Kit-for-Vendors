...
{
    /// <summary>
    /// TpdmRecruitmentEventAttendanceRace
    /// </summary>
    [DataContract(Name = "tpdm_recruitmentEventAttendanceRace")]
    public partial class TpdmRecruitmentEventAttendanceRace : IEquatable<TpdmRecruitmentEventAttendanceRace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendanceRace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TpdmRecruitmentEventAttendanceRace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TpdmRecruitmentEventAttendanceRace" /> class.
        /// </summary>
        ...
        public TpdmRecruitmentEventAttendanceRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            this.RaceDescriptor = raceDescriptor ?? throw new ArgumentNullException("raceDescriptor is a required property for TpdmRecruitmentEventAttendanceRace and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TpdmRecruitmentEventAttendanceRace {\n");
        ...
        {
            return this.Equals(input as TpdmRecruitmentEventAttendanceRace);
        }

        /// <summary>
        /// Returns true if TpdmRecruitmentEventAttendanceRace instances are equal
        /// </summary>
        /// <param name="input">Instance of TpdmRecruitmentEventAttendanceRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TpdmRecruitmentEventAttendanceRace input)
        {
            if (input == null)
                return false;
