...
namespace EdFi.Roster.Sdk.Models.EnrollmentComposites
{
    ...
    /// StaffStaffRace
    /// </summary>
    [DataContract(Name = "staff_staffRace")]
    public partial class StaffStaffRace : IEquatable<StaffStaffRace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffStaffRace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StaffStaffRace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffStaffRace" /> class.
        /// </summary>
        ...
        public StaffStaffRace(string raceDescriptor = default(string))
        {
            // to ensure "raceDescriptor" is required (not null)
            this.RaceDescriptor = raceDescriptor ?? throw new ArgumentNullException("raceDescriptor is a required property for StaffStaffRace and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StaffStaffRace {\n");
        ...
        {
            return this.Equals(input as StaffStaffRace);
        }

        /// <summary>
        /// Returns true if StaffStaffRace instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffStaffRace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffStaffRace input)
        {
            if (input == null)
                return false;
