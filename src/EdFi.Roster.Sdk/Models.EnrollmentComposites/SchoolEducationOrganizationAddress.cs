...
namespace EdFi.Roster.Sdk.Models.EnrollmentComposites
{
    ...
    /// </summary>
    [DataContract(Name = "school_educationOrganizationAddress")]
    public partial class SchoolEducationOrganizationAddress : IEquatable<SchoolEducationOrganizationAddress>, IValidatableObject
    {
        /// <summary>
        ...
        public SchoolEducationOrganizationAddress(string addressTypeDescriptor = default(string), string streetNumberName = default(string), string city = default(string), string stateAbbreviationDescriptor = default(string), string postalCode = default(string), string nameOfCounty = default(string))
        {
            ...
            this.AddressTypeDescriptor = addressTypeDescriptor ?? throw new ArgumentNullException("addressTypeDescriptor is a required property for SchoolEducationOrganizationAddress and cannot be null");
            // to ensure "streetNumberName" is required (not null)
            this.StreetNumberName = streetNumberName ?? throw new ArgumentNullException("streetNumberName is a required property for SchoolEducationOrganizationAddress and cannot be null");
            // to ensure "city" is required (not null)
            this.City = city ?? throw new ArgumentNullException("city is a required property for SchoolEducationOrganizationAddress and cannot be null");
            // to ensure "stateAbbreviationDescriptor" is required (not null)
            this.StateAbbreviationDescriptor = stateAbbreviationDescriptor ?? throw new ArgumentNullException("stateAbbreviationDescriptor is a required property for SchoolEducationOrganizationAddress and cannot be null");
            // to ensure "postalCode" is required (not null)
            this.PostalCode = postalCode ?? throw new ArgumentNullException("postalCode is a required property for SchoolEducationOrganizationAddress and cannot be null");
