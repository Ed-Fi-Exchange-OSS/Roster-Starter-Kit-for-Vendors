...
namespace EdFi.Roster.Sdk.Models.EnrollmentComposites
{
    ...
    /// StaffStaffTelephone
    /// </summary>
    [DataContract(Name = "staff_staffTelephone")]
    public partial class StaffStaffTelephone : IEquatable<StaffStaffTelephone>, IValidatableObject
    {
        ...
        public StaffStaffTelephone(string telephoneNumberTypeDescriptor = default(string), int orderOfPriority = default(int), string telephoneNumber = default(string))
        {
            ...
            this.TelephoneNumberTypeDescriptor = telephoneNumberTypeDescriptor ?? throw new ArgumentNullException("telephoneNumberTypeDescriptor is a required property for StaffStaffTelephone and cannot be null");
            // to ensure "telephoneNumber" is required (not null)
            this.TelephoneNumber = telephoneNumber ?? throw new ArgumentNullException("telephoneNumber is a required property for StaffStaffTelephone and cannot be null");
