...
namespace EdFi.Roster.Sdk.Models.EnrollmentComposites
{
    ...
    /// </summary>
    [DataContract(Name = "staff_staffEducationOrganizationAssignmentAssociation")]
    public partial class StaffStaffEducationOrganizationAssignmentAssociation : IEquatable<StaffStaffEducationOrganizationAssignmentAssociation>, IValidatableObject
    {
        ...
        public StaffStaffEducationOrganizationAssignmentAssociation(string staffClassificationDescriptor = default(string), string educationOrganizationType = default(string), int educationOrganizationId = default(int))
        {
            ...
            this.StaffClassificationDescriptor = staffClassificationDescriptor ?? throw new ArgumentNullException("staffClassificationDescriptor is a required property for StaffStaffEducationOrganizationAssignmentAssociation and cannot be null");
