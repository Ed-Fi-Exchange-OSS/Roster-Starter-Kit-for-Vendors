...
{
    /// <summary>
    /// SchoolEducationOrganizationIdentificationCode
    /// </summary>
    [DataContract(Name = "school_educationOrganizationIdentificationCode")]
    public partial class SchoolEducationOrganizationIdentificationCode : IEquatable<SchoolEducationOrganizationIdentificationCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchoolEducationOrganizationIdentificationCode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SchoolEducationOrganizationIdentificationCode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchoolEducationOrganizationIdentificationCode" /> class.
        /// </summary>
        ...
        public SchoolEducationOrganizationIdentificationCode(string educationOrganizationIdentificationSystemDescriptor = default(string), string identificationCode = default(string))
        {
            // to ensure "educationOrganizationIdentificationSystemDescriptor" is required (not null)
            this.EducationOrganizationIdentificationSystemDescriptor = educationOrganizationIdentificationSystemDescriptor ?? throw new ArgumentNullException("educationOrganizationIdentificationSystemDescriptor is a required property for SchoolEducationOrganizationIdentificationCode and cannot be null");
            // to ensure "identificationCode" is required (not null)
            this.IdentificationCode = identificationCode ?? throw new ArgumentNullException("identificationCode is a required property for SchoolEducationOrganizationIdentificationCode and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchoolEducationOrganizationIdentificationCode {\n");
        ...
        {
            return this.Equals(input as SchoolEducationOrganizationIdentificationCode);
        }

        /// <summary>
        /// Returns true if SchoolEducationOrganizationIdentificationCode instances are equal
        /// </summary>
        /// <param name="input">Instance of SchoolEducationOrganizationIdentificationCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchoolEducationOrganizationIdentificationCode input)
        {
            if (input == null)
                return false;
