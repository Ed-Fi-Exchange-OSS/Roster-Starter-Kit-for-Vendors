...
namespace EdFi.Roster.Sdk.Models.EnrollmentComposites
{
    ...
    /// StaffStaffLanguage
    /// </summary>
    [DataContract(Name = "staff_staffLanguage")]
    public partial class StaffStaffLanguage : IEquatable<StaffStaffLanguage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffStaffLanguage" /> class.
        /// </summary>
        [JsonConstructor]
        protected StaffStaffLanguage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffStaffLanguage" /> class.
        /// </summary>
        /// <param name="languageDescriptor">A specification of which written or spoken communication is being used. (required).</param>
        public StaffStaffLanguage(string languageDescriptor = default(string))
        {
            // to ensure "languageDescriptor" is required (not null)
            this.LanguageDescriptor = languageDescriptor ?? throw new ArgumentNullException("languageDescriptor is a required property for StaffStaffLanguage and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StaffStaffLanguage {\n");
        ...
        {
            return this.Equals(input as StaffStaffLanguage);
        }

        /// <summary>
        /// Returns true if StaffStaffLanguage instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffStaffLanguage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffStaffLanguage input)
        {
            if (input == null)
                return false;
