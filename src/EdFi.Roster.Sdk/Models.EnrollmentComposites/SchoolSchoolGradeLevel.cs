...
{
    /// <summary>
    /// SchoolSchoolGradeLevel
    /// </summary>
    [DataContract(Name = "school_schoolGradeLevel")]
    public partial class SchoolSchoolGradeLevel : IEquatable<SchoolSchoolGradeLevel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchoolSchoolGradeLevel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SchoolSchoolGradeLevel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchoolSchoolGradeLevel" /> class.
        /// </summary>
        /// <param name="gradeLevelDescriptor">The grade levels served at the school. (required).</param>
        public SchoolSchoolGradeLevel(string gradeLevelDescriptor = default(string))
        {
            // to ensure "gradeLevelDescriptor" is required (not null)
            this.GradeLevelDescriptor = gradeLevelDescriptor ?? throw new ArgumentNullException("gradeLevelDescriptor is a required property for SchoolSchoolGradeLevel and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchoolSchoolGradeLevel {\n");
        ...
        {
            return this.Equals(input as SchoolSchoolGradeLevel);
        }

        /// <summary>
        /// Returns true if SchoolSchoolGradeLevel instances are equal
        /// </summary>
        /// <param name="input">Instance of SchoolSchoolGradeLevel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchoolSchoolGradeLevel input)
        {
            if (input == null)
                return false;
